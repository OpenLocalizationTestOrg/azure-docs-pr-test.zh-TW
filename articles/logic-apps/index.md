        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>結構描述</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">工作流程定義語言</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">工作流程動作與觸發程序</a></p>
                   </div>
                </div>
            </div>
        </div>
