...
## [複寫 HYPER-V Vm tooAzure](hyper-v-site-walkthrough-overview.md)
...
### [步驟 1： 檢閱 hello 架構](physical-walkthrough-architecture.md)
...
### [移轉 AWS Windows 執行個體 tooAzure](site-recovery-migrate-aws-to-azure.md)
