...
3. **來源與目標**：
    ...
    ![VMM/Hyper-v-V 複寫至 Azure](./media/site-recovery-components/arch-onprem-onprem-azure-vmm.png) ![HYPER-V 站台複寫至 Azure](./media/site-recovery-components/arch-onprem-azure-hypervsite.png)
