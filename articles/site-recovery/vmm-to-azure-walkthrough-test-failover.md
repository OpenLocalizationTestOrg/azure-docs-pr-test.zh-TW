...
1. <span data-ttu-id="4d283-138">在**受保護項目**，按一下**複寫的項目**，然後按一下 hello VM。</span><span class="sxs-lookup"><span data-stu-id="4d283-138">In **Protected Items**, click **Replicated Items**, and click hello VM.</span></span>
