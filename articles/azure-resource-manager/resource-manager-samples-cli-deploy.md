...
---
# <a name="azure-resource-manager-template-deployment---azure-cli-script"></a>Azure Resource Manager 範本部署 - Azure CLI 指令碼
...
| 命令 | 注意事項 |
|---|---|
| [az group exists](/cli/azure/group#exists) | 檢查資源群組是否存在。 |
| [az group create](/cli/azure/group#create) | 建立用來存放所有資源的資源群組。 |
| [az group deployment create](/cli/azure/group/deployment#create) | 開始部署。  |
| [az group delete](/cli/azure/group#delete) | 刪除資源群組，包括其所有資源。 |
