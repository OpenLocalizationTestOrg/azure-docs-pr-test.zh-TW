...
- 在您的 Azure 資料表儲存體中的主機電腦 tooread hello 訊息，然後執行範例程式碼。 
...
- [建立 hello Azure 函式應用程式和 hello Azure 儲存體帳戶](iot-hub-gateway-kit-c-lesson4-deploy-resource-manager-template.md)。
- [執行應用程式-閘道範例 hello](iot-hub-gateway-kit-c-lesson3-configure-ble-app.md)。
...
當做 hello 值使用 iot 閘道`{resource group name}`如果您沒有變更 hello 課程 2 中的值。
