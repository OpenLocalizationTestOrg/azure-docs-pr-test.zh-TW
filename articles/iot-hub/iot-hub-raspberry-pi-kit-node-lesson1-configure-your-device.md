...
設定第一次使用 Pi 和 hello Raspbian 作業系統安裝。 Raspbian 是可用的最適合用於 hello 覆盆子 Pi 硬體上的作業系統。 如果您有任何問題，您可以搜尋解決方案 hello[疑難排解頁面](iot-hub-raspberry-pi-kit-node-troubleshooting.md)。
...
* USB SD 卡或 miniSD 卡 tooburn hello 作業系統映像到 hello microSD 卡。
