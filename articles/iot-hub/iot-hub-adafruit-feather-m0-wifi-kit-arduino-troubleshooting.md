...
如需解決常見的問題 Adafruit 羽毛 M0 WiFi Arduino 面板上的資訊，請參閱 hello[正式的疑難排解頁面](https://learn.adafruit.com/adafruit-feather-m0-wifi-atwinc1500?view=all#faq)。
...
您可以新增或`--listen`tooopen 序列埠 toooutput 裝置記錄檔資訊。
