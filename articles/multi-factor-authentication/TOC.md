...
## [如何 tooget Azure MFA](multi-factor-authentication-versions-plans.md)

# 開始使用
## [選擇位置 toodeploy](multi-factor-authentication-get-started.md)
## [Hello 雲端中的 MFA](multi-factor-authentication-get-started-cloud.md)
...
### 部署 MFA 內部部署
#### [安裝 hello 使用者入口網站](multi-factor-authentication-get-started-portal.md)
