...
Azure 的堆疊可讓雲端系統管理員可讓使用者使用自訂的虛擬機器映像。 這些映像可供 Azure Resource Manager 範本參考，或藉由建立 Marketplace 項目新增到 Azure Marketplace UI。 
...
2. Azure 堆疊雲端系統管理員身分登入 > 從功能表中，按一下 **更多服務** > **資源提供者**> 選取**計算** >  **VM 映像** > **新增**
