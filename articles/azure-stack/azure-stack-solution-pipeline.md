...
### <a name="azure"></a>Azure
 ...
 - 建立 [Web 應用程式](../app-service-web/app-service-web-how-to-create-a-web-app-in-an-ase.md)，並將其設定為用於 [FTP 發行](../app-service-web/app-service-deploy-ftp.md)。  記下新的 Web 應用程式 URL，因為稍後將會用到。
