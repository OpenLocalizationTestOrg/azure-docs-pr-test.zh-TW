...
|:--- |:--- |:--- |:--- |
| 底座 |1 |否 |[取代您的 StorSimple 裝置上的 hello 底座](storsimple-8000-chassis-replacement.md) |
...
| 備用電池 |2 |是 |[取代您的 StorSimple 裝置上的 hello 備用電池模組](storsimple-8000-battery-replacement.md) |
...
請[連絡 Microsoft 支援服務](storsimple-8000-contact-microsoft-support.md)tooorder 其中任何更換裝置。
