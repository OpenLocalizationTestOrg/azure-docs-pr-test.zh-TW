...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal-update-2"></a>部署在 hello 政府入口網站 (Update 2) 在內部部署 StorSimple 裝置
[!INCLUDE [storsimple-version-selector-deploy-gov](../../includes/storsimple-version-selector-deploy-gov.md)]

## <a name="overview"></a>概觀
歡迎使用 tooMicrosoft Azure StorSimple 裝置部署。 這些部署教學課程適用於 toohello StorSimple 8000 系列執行 Update 2 中的軟體 hello Azure 政府入口網站。 這一系列的教學課程包含 StorSimple 裝置的設定檢查清單、設定必要條件的清單，以及詳細的設定步驟。
...
執行下列必要的步驟 tooconfigure StorSimple 裝置，並將它連接 tooyour StorSimple Manager 服務。 此外 toohello 所需的步驟，選擇性的步驟和程序，您可能需要 toocomplete hello 部署期間。 您應該執行每一個選擇性的步驟時，就會指出 hello 逐步部署指示。
