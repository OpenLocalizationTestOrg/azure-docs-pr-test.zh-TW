...
## 概觀
### [什麼是 hello 方案？](storsimple-ova-overview.md)
...
### 部署
#### [準備 toodeploy](storsimple-virtual-array-deploy1-portal-prep.md)
...
## 概觀
### [什麼是 hello 方案？](storsimple-overview.md)
...
##### [從遠端連線 tooyour 裝置](storsimple-8000-remote-connect.md)
##### [停用及刪除您的裝置](storsimple-8000-deactivate-and-delete-device.md)
##### [容錯移轉您的裝置](storsimple-8000-device-failover-disaster-recovery.md)
###### [容錯移轉 toophysical 裝置](storsimple-8000-device-failover-physical-device.md)
###### [容錯移轉 toocloud 應用裝置](storsimple-8000-device-failover-cloud-appliance.md)
###### [容錯移轉 toosame 裝置](storsimple-8000-device-failover-same-device.md)
...
#### [自動化 DR tooAzure 的檔案伺服器](storsimple-disaster-recovery-using-azure-site-recovery.md)
...
#### [從其他存放裝置](http://download.microsoft.com/download/9/4/A/94AB8165-CCC4-430B-801B-9FD40C8DA340/Migrating Data tooStorSimple Volumes_09-02-15.pdf)
...
##### [從遠端連線 tooyour 裝置](storsimple-remote-connect.md)
...
## 版本資訊
### [Update 4 - 目前](storsimple-update4-release-notes.md)
### [Update 3](storsimple-update3-release-notes.md)
### [Update 2.2](storsimple-update21-release-notes.md)
...
## 概觀
### [什麼是 hello 方案？](storsimple-data-manager-overview.md)

## 開始使用
### [使用 StorSimple Data Manager](storsimple-data-manager-ui.md)

## 作法
### [使用.NET toostart 作業](storsimple-data-manager-dotnet-jobs.md)
### [使用自動化 toostart 作業](storsimple-data-manager-job-using-automation.md)
### [變更預設 Blob 路徑](storsimple-data-manager-change-default-blob-path.md)

# 供合作夥伴使用的 StorSimple

## 概觀
### [什麼是 hello 方案？](storsimple-partner-csp-overview.md)
