...
---
# <a name="use-hello-storsimple-device-manager-service-toomonitor-hardware-components-and-status"></a>使用 hello StorSimple 裝置管理員服務 toomonitor 硬體元件和狀態
## <a name="overview"></a>概觀
本文說明 hello 您在內部部署 StorSimple 8000 系列裝置的各種實體和邏輯元件。 它也會說明 toomonitor 如何使用 hello hello 裝置元件狀態**狀態和硬體的健全狀況**hello StorSimple 裝置管理員服務在刀鋒視窗。

hello**狀態和硬體的健全狀況**刀鋒視窗會顯示所有 hello StorSimple 裝置元件 hello 硬體狀態。
...
> [!NOTE]
> **無法使用 StorSimple 雲端應用裝置 (8010/8020) hello 硬體狀態。**


## <a name="monitor-hello-hardware-status"></a>監視 hello 硬體狀態
執行下列步驟 tooview hello 硬體裝置元件狀態的 hello:

1. 瀏覽過**裝置**，選取特定的 StorSimple 裝置。 跳過**監視 > 硬體健全狀況**。

    ![](./media/storsimple-8000-monitor-hardware-status/hw-health1.png)

2. 找出 hello**硬體元件**區段，然後選擇 從 hello 可用的元件。 只要按一下 hello 元件標籤 tooexpand hello 清單，然後檢視 hello hello 狀態的各種裝置元件。 請參閱 hello [hello 主要機箱的詳細的元件清單](#component-list-for-primary-enclosure-of-storsimple-device)和 hello [hello EBOD 機箱的詳細的元件清單](#component-list-for-ebod-enclosure-of-storsimple-device)。
...
3. 使用下列的色彩編碼配置 toointerpret hello 元件狀態的 hello:
   ...
   * **白底黑字** – 代表不存在的元件。
   ...
   hello 下列螢幕擷取畫面顯示具有元件中的裝置**確定**，**警告**，和**失敗**狀態。
       
   ![](./media/storsimple-8000-monitor-hardware-status/hw-health3.png)

   擴充的 hello**共用的元件清單**，我們可以看到該 hello NVRAM 與 hello 叢集已降級。

   ![](./media/storsimple-8000-monitor-hardware-status/hw-health5.png)

   擴充的 hello**控制器 1 元件** 清單中，我們可以看到該 hello 叢集節點失敗。  
...
hello 表概述 hello hello 主要機箱 （出現在 8100 和 8600） 在內部部署 StorSimple 裝置中包含的實體和邏輯元件。
...
hello 表概述 hello hello EBOD 機箱 （只出現在 8600 模型） 的內部部署 StorSimple 裝置中包含的實體和邏輯元件。
...
* toouse hello StorSimple 裝置管理員服務 tooadminister 您的裝置，請跳過[使用 hello StorSimple 裝置管理員服務 tooadminister StorSimple 裝置](storsimple-8000-manager-service-administration.md)。
...
* 如果您繼續 tooexperience 裝置問題，[連絡 Microsoft 支援服務](storsimple-8000-contact-microsoft-support.md)。
