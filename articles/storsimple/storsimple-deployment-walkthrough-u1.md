...
歡迎使用 tooMicrosoft Azure StorSimple 裝置部署。 這些部署教學課程適用於 tooStorSimple 8000 系列 Update 1.0。 這一系列的教學課程說明如何 tooconfigure StorSimple 裝置，而且包含設定檢查清單、 設定必要條件和詳細的設定步驟。
...
> [!IMPORTANT]
> StorSimple Manager 只能建立精簡佈建的磁碟區。 您無法建立完整佈建或部分佈建的磁碟區。
> 
> 
