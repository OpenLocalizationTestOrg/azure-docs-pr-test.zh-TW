                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Azure 開發人員快速入門指南</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">開始使用 Azure</h2>
                                    <p>透過快速入門、範例及教學課程探索我們最熱門的服務。</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>關聯式資料庫</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">SQL Database 即服務</a></li>
                                                    <li><a class="barLink" href="/azure/postgresql/">PostgreSQL 即服務</a></li>
                                                    <li><a class="barLink" href="/azure/mysql/">MySQL 即服務</a></li>
                                                </ul>
                                                <h4>NoSQL</h4>
                                                <ul class="noBullet">
                            ...
                            <li class="bottomRightItem">
                                ...
                                <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">檢視所有 Azure 服務<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z"/></svg></button>
                                </a>
                            </li>
                            </li>
                        </ul>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 虛擬機器</h3>
                                                    <p>佈建適用於 SQL Server、SharePoint 等的虛擬機器</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>在 Windows 或 Linux 上開發微服務及協調容器</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>應用程式閘道</h3>
                                                    <p>內建 HTTP 負載平衡及傳遞控制的第 7 層負載平衡器</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>部署 Mobile Apps、收集意見回應與損毀報告，以及監視使用量</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 資源健康狀態</h3>
                                                    <p>當 Azure 問題影響到您的資源時，協助診斷並取得支援</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/dotnet/azure/?view=azure-dotnet">API 參考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/python">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure.github.io/azure-sdk-for-node/">API 參考</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=nodejs">取得範例</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/nodejs">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://github.com/Azure/azure-sdk-for-ruby/blob/master/README.md">API 參考</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=ruby">取得範例</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/ruby/">深入了解</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/rest/api/">開始使用 REST</a>
                                                </h3>
                                                <p>
                                                    <a href="/rest/api">參考</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=rest">取得範例</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="http://storageexplorer.com">儲存體總管</a>
                                                </h3>
                                                <p>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>雲端應用程式的最佳做法</h3>
                                                    <p>一組適用於雲端應用程式的最佳做法，其中涵蓋自動調整、快取、資料分割、API 設計和監視等層面。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
