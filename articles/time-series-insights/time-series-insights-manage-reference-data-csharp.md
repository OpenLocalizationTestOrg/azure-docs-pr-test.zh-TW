...
---
# <a name="manage-reference-data-for-an-azure-time-series-insights-environment-by-using-c"></a><span data-ttu-id="68836-103">使用 C# 來管理 Azure Time Series Insights 環境的參考資料</span><span class="sxs-lookup"><span data-stu-id="68836-103">Manage reference data for an Azure Time Series Insights environment by using C#</span></span>

<span data-ttu-id="68836-104">這個 C# 範例示範如何管理 Azure Time Series Insights 環境的參考資料。</span><span class="sxs-lookup"><span data-stu-id="68836-104">This C# sample demonstrates how to manage reference data for an Azure Time Series Insights environment.</span></span>
<span data-ttu-id="68836-105">執行此範例之前，請確定已完成下列步驟。</span><span class="sxs-lookup"><span data-stu-id="68836-105">Before running the sample, ensure the following steps are completed.</span></span>
1. <span data-ttu-id="68836-106">已使用[這篇文章](time-series-insights-add-reference-data-set.md)來建立參考資料集。</span><span class="sxs-lookup"><span data-stu-id="68836-106">A reference data set has been created using [this article](time-series-insights-add-reference-data-set.md).</span></span>
2. <span data-ttu-id="68836-107">已透過 Azure Active Directory API 取得執行應用程式時使用的存取權杖。</span><span class="sxs-lookup"><span data-stu-id="68836-107">The access token used when running the application is acquired through the Azure Active Directory API.</span></span> <span data-ttu-id="68836-108">應該在每個「查詢」API 要求的 `Authorization` 標頭中傳送此權杖。</span><span class="sxs-lookup"><span data-stu-id="68836-108">This token should be passed in the `Authorization` header of every Query API request.</span></span> <span data-ttu-id="68836-109">如需了解如何設定非互動式應用程式，請參閱[驗證與授權](time-series-insights-authentication-and-authorization.md)一文。</span><span class="sxs-lookup"><span data-stu-id="68836-109">For setting up non-interactive applications, see the [Authentication and authorization](time-series-insights-authentication-and-authorization.md) article.</span></span>
3. <span data-ttu-id="68836-110">已正確設定在此範例開頭定義的所有常數。</span><span class="sxs-lookup"><span data-stu-id="68836-110">All the constants defined at the beginning of the sample are correctly set.</span></span>

## <a name="c-sample"></a><span data-ttu-id="68836-111">C# 範例</span><span class="sxs-lookup"><span data-stu-id="68836-111">C# sample</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="68836-112">後續步驟</span><span class="sxs-lookup"><span data-stu-id="68836-112">Next steps</span></span>

<span data-ttu-id="68836-113">如需完整的 API 參考，請參閱[參考資料 API](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) 文件。</span><span class="sxs-lookup"><span data-stu-id="68836-113">For the complete API reference, see [Reference Data API](/rest/api/time-series-insights/time-series-insights-reference-reference-data-api) document.</span></span>