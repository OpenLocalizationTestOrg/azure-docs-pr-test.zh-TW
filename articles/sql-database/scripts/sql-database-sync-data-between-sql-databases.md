...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>使用多個 Azure SQL database 之間的 PowerShell toosync
 
這個 PowerShell 範例會設定多個 Azure SQL database 之間的資料同步 toosync。
