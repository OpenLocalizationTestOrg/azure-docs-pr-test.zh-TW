...
---
# <a name="use-powershell-toomonitor-and-scale-a-single-sql-database"></a>使用 PowerShell toomonitor 並縮放單一的 SQL 資料庫

監視 hello 效能度量資訊的資料庫，這個 PowerShell 指令碼範例會調整它 tooa 較高的效能層級，以及 hello 效能度量的其中一個上建立警示規則。 
