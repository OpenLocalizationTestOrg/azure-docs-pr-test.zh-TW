...
---
# <a name="use-powershell-tooconfigure-an-active-geo-replication-failover-group-for-a-single-azure-sql-database"></a>使用 PowerShell tooconfigure 作用中地理複寫容錯移轉群組為單一的 Azure SQL database

這個 PowerShell 指令碼範例會設定為單一的 Azure SQL database 的作用中地理複寫容錯移轉群組，並容錯 tooa hello Azure SQL database 的次要複本。
