...
---
# <a name="use-powershell-tooimport-a-bacpac-file-into-an-azure-sql-database"></a>使用 PowerShell tooimport bacpac 檔案到 Azure SQL database
...
| [New-AzureRmSqlServer](/powershell/module/azurerm.sql/new-azurermsqlserver) | 建立主機 hello SQL Database 邏輯伺服器。 |
| [New-AzureRmSqlServerFirewallRule](/powershell/module/azurerm.sql/new-azurermsqlserverfirewallrule) | Hello hello 輸入 IP 位址範圍內的伺服器上建立防火牆規則 tooallow 存取 tooall SQL 資料庫。 |
| [New-AzureRmSqlDatabaseImport (英文)](/powershell/module/azurerm.sql/new-azurermsqldatabaseimport) | 匯入的.bacpac 檔案，並在 hello 伺服器上建立新的資料庫。 |
