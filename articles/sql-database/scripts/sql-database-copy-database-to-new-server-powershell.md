...
---
# <a name="use-powershell-toocopy-a-sql-database-tooa-new-server"></a>使用 PowerShell toocopy SQL database tooa 新伺服器

此 PowerShell 指令碼範例會在新伺服器中建立現有資料庫的複本。 

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

## <a name="copy-a-database-tooa-new-server"></a>複製資料庫 tooa 新伺服器
...
| [New-AzureRmSqlDatabaseCopy](/powershell/module/azurerm.sql/new-azurermsqldatabasecopy) | 建立一份使用 hello 快照集在 hello 目前時間的資料庫。 |
