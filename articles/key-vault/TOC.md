...
### [移轉 too.NET 2.0](key-vault-dotnet2api-release-notes.md)
### 概觀
...
### [如何 toouse 金鑰保存庫虛刪除與 CLI](key-vault-soft-delete-cli.md)
### [如何 toouse 金鑰保存庫虛刪除使用 PowerShell](key-vault-soft-delete-powershell.md)
### [使用群組 toogrant 存取](key-vault-group-permissions-for-apps.md)
