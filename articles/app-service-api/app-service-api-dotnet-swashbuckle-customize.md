---
title: "自訂 Swashbuckle 產生的 API 定義"
...
2. 新增在 *SwaggerConfig.cs* 檔案中的指示，以引導 Swashbuckle 使用 XML 文件檔案。
...
3. 若要產生 XML 文件檔案，請進入專案的屬性，然後啟用 XML 文件檔案，如以下螢幕擷取畫面所示。 
...
### <a name="customize-expected-response-codes-using-the-swaggerresponse-attribute"></a>使用 SwaggerResponse 屬性自訂預期的回應碼
...
2. 按一下在 Swashbuckle NuGet 套件旁的 [更新]。 
   
    ![](./media/app-service-api-dotnet-swashbuckle-customize/update-nuget-dialog.png)
3. 新增 *SwaggerResponse* 屬性到您想指定有效 HTTP 回應碼的 Web API 動作方法中。 
...
4. 為屬性的命名空間新增 `using` 陳述式：
   
        using Swashbuckle.Swagger.Annotations;
5. 瀏覽至在 Swagger JSON 中可看見您專案和各種不同 HTTP 回應碼的 URL */swagger/docs/v1* 。 
