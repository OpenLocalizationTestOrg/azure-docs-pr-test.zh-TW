...
## [什麼是 App Service？](../app-service/app-service-value-prop-what-is.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
## [運作方式](../app-service/app-service-how-works-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [Azure App Service 的最佳做法](../app-service-web/app-service-best-practices.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [本機 Git 部署](../app-service-web/app-service-deploy-local-git.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [使用 Visual Studio 部署 WebJob](../app-service-web/websites-dotnet-deploy-webjobs.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)

## [調整](../app-service/app-service-scale-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [相應增加應用程式](../app-service-web/web-sites-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [App Service 環境](../app-service/app-service-app-service-environments-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [App Service 環境的異地分散調整](../app-service-web/app-service-app-service-environment-geo-distributed-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [在 App Service 環境中調整應用程式](../app-service-web/app-service-web-scale-a-web-app-in-an-app-service-environment.md)
#### [在 App Service 環境中自動調整](../app-service/app-service-environment-auto-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)

## 管理
### [設定](../app-service-web/web-sites-configure.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### 自訂網域
...
### [內部部署連線](../app-service-web/web-sites-hybrid-connection-get-started.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [在 Azure App Service 中保護應用程式](../app-service-web/web-sites-security.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [驗證和授權](../app-service/app-service-authentication-overview.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### 使用識別提供者進行驗證
#### [Azure Active Directory 驗證](app-service-mobile-how-to-configure-active-directory-authentication.md)
#### [Facebook 驗證](app-service-mobile-how-to-configure-facebook-authentication.md)
#### [Google 驗證](app-service-mobile-how-to-configure-google-authentication.md)
#### [Microsoft 帳戶驗證](app-service-mobile-how-to-configure-microsoft-authentication.md)
#### [Twitter 驗證](app-service-mobile-how-to-configure-twitter-authentication.md)
### [使用內部部署 Active Directory 進行驗證](../app-service-web/web-sites-authentication-authorization.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)

### HTTPS
#### [設定 TLS 相互驗證](../app-service-web/app-service-web-configure-tls-mutual-auth.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [購買 Azure 中的 SSL 憑證](../app-service-web/web-sites-purchase-ssl-web-site.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [使用其他地方取得的 SSL 憑證](../app-service-web/web-sites-configure-ssl-certificate.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
## 自動化
### [敏捷式開發](../app-service-web/app-service-agile-software-development.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [使用自訂主機名稱與 SSL 憑證的 MSDeploy](../app-service-web/app-service-web-arm-with-msdeploy-provision.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### Powershell
#### [自動化備份和還原](../app-service/app-service-powershell-backup.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [應用程式複製](../app-service-web/app-service-web-app-cloning.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [SSL 憑證繫結](../app-service-web/app-service-web-app-powershell-ssl-binding.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [使用包含 PowerShell 的 Azure Resource Manager](../app-service-web/app-service-web-app-azure-resource-manager-powershell.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
