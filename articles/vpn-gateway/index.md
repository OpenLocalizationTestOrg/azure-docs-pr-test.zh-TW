        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>命令列</h3>
                        <p><a href="/powershell/module/azurerm.network/#vpn">PowerShell (資源管理員)</a></p>
                        <p><a href="/powershell/module/azure/#networking">PowerShell (傳統)</a></p> 
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/network/virtualnetworkgateways">REST (資源管理員)</a></p>
                        <p><a href="https://msdn.microsoft.com/library/jj154113">REST (傳統)</a></p>
                    </div>
                </div>
            </div>
        </div>
