...
### [Azure 入口網站](search-create-index-portal.md)
...
### [升級 hello SDK](search-dotnet-sdk-migration.md)
### [升級 hello REST API](search-api-migration.md)
...
### [在 Azure VM 上設定索引子連線 tooSQL 伺服器](search-howto-connecting-azure-sql-iaas-to-azure-search-using-indexers.md)
