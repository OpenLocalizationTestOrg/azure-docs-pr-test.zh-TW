...
讓我們推銷您的專案！ Hello 實用的專案，您和使用 Azure Cosmos DB hello 新一代的 hello DocumentDB 堆疊，告訴我們，我們會助您天才分享 hello world。 toosubmit 您的專案，在電子郵件傳送給我們： [ askcosmosdb@microsoft.com ](mailto:askcosmosdb@microsoft.com)。
...
用戶端管理檢視器/總管 hello Azure Cosmos DB DocumentDB API 服務。
...
寫入 typescript hello Node.js 用戶端的包裝函式 （適用於一般 javascript 太）。 支援 `async/await` 和簡化的 API。
...
Hello DocumentDB API，可以輕鬆地部署 API 應用程式為 Azure Cosmos DB REST API Swagger 檔案。
...
關於 fluent 外掛程式 documentdb 是輸出 tooAzure Cosmos DB DocumentDB API 的 Fluentd 外掛程式。
...
您可以保持最新 Azure Cosmos DB 消息 hello 與功能最新狀態依照[我們的部落格](https://azure.microsoft.com/blog/tag/documentdb/)。

**社群貼文：**

* [**旅程 tooSocial**](https://medium.com/@Ealsur/a-journey-to-social-c47636bf25c9#.an669sx41) - *Matías Quaranta 由* 
* [**預覽版中 MongoDB 的 Azure DocumentDB 通訊協定支援 - 使用 Sitecore 的測試**](https://alwaysupalwayson.blogspot.ca/2016/05/azure-documentdb-protocol-support-for.html) (英文)  - *作者：Mathieu Benoit* 
* [**使用 DocumentDB 進行社交活動**](https://blogs.msdn.microsoft.com/mvpawardprogram/2016/03/15/going-social-with-documentdb/) (英文)  - *作者：Matías Quaranta*
* [**UWP、Azure App Service 和 DocumentDB Soup：分享照片的應用程式**](https://blogs.windows.com/buildingapps/2016/03/17/uwp-azure-app-services-and-documentdb-soup-a-photo-sharing-app/) (英文)  - *作者：Eric Langland*
* [**收集記錄檔中使用 fluent 外掛程式 documentdb DocumentDB tooAzure**](http://unofficialism.info/posts/collecting-logs-into-azure-documentdb-using-fluent-plugin-documentdb/) - *Yoichi Kawasaki 由*
* [**DocumentDB 進行重新瀏覽組件 1/2 – hello 理論**](https://peterintheazuresky.wordpress.com/2016/02/19/documentdb-revisited-part-12-the-theory/) - *由 Peter Mannerhult*
* [**哪些 toolove 和關於 Azure 的 DocumentDB 仇恨**](http://blog.falafel.com/4-what-to-love-and-hate-about-azures-documentdb/) - *George Saadeh 由*
* [**Azure DocumentDB 伺服器端指令碼**](https://www.simple-talk.com/cloud/cloud-data/azure-documentdb-server-side-scripting/) (英文)  - *作者：Robert Sheldon*
* [**把 DocumentDB 當做 Azure 串流分析的資料接收器**](http://janatdevelopment.com/2015/12/11/documentdb-as-a-data-sink-for-azure-stream-analytics/?utm_source=twitterfeed&utm_medium=twitter) (英文)  - *作者：Jan Hentschel*
* [**Azure 搜尋服務索引工具 – DocumentDB 查詢 (西班牙文)**](http://www.ealsur.com.ar/wp/index.php/2015/11/19/azure-search-indexers-documentdb-queries/) - *作者：Matthias Quaranta*
* [**Azure DocumentDB SQL 查詢基礎 (日文)**](http://beachside.hatenablog.com/entry/2015/12/06/000045) - *作者：Atsushi Yokohama*
* [**資料點 - 當 Aurelia 遇上 DocumentDB：媒人之旅**](https://msdn.microsoft.com/magazine/mt620011.aspx) (英文)  - *作者：Julie Lerman*
* [**基礎結構即程式碼與連續部署 Node.js + Azure DocumentDB 方案**](http://www.talmeida.net/blog/2015/10/26/infrastructure-as-code-and-continuous-deployment-of-a-nodejs-azure-documentdb-solution) (英文)  - *作者：Thiago Almedia*
* [**為何 DocumentDb 對某些專案確實有商業價值**](http://www.iquestllc.com/blogs/read/405/why-documentdb-makes-good-business-sense-for-some-projects) (英文)  - *作者：Samuel Uresin*
* [**Azure DocumentDB 開發接下來 – hello 用戶端類別 (2 之 1) 的開發 （日文）**](http://beachside.hatenablog.com/entry/2015/10/01/202734) - *Atsushi 橫濱由*
* [**使用 Azure DocumentDB （日文） 時，您需要 tooknow 事情**](http://beachside.hatenablog.com/entry/2015/10/01/202734) - *Atsushi 橫濱由*
* [**資料點 - Microsoft Azure DocumentDB 概觀**](https://msdn.microsoft.com/magazine/mt147238.aspx) (英文)  - *作者：Julie Lerman*
* [**搭配 F# 來使用 DocumentDB**](https://jamessdixon.wordpress.com/2014/12/30/using-documentdb-with-f/) (英文)  - *作者：Jamie Dixon*
* [**使用 DocumentDB 分析應用程式記錄檔**](http://vincentlauzon.com/2015/09/06/analysing-application-logs-with-documentdb/) (英文)  - *作者：Vincent-Philippe Lauzon*
* [**Azure DocumentDB – 備份時間點**](http://softwarejuancarlos.com/2015/09/06/azure-documentdb-point-in-time-backups/) (英文)  - *作者：Juan Carlos Sanchez*

*您是否有部落格文章、 程式碼範例，或案例研究您想要 tooshare？[請告訴我們](mailto:askcosmosdb@microsoft.com)！*
...
|[NDC Olso 2017: Azure DocumentDB-hello 最佳 NoSQL 資料庫您可能不使用 （尚未）](http://ndcoslo.com/talk/azure-cosmos-db-the-best-nosql-database-youre-probably-not-using-yet/)|[Josh Lane](https://twitter.com/jplane)|挪威奧斯陸|2017 年 6 月 14 日|[#ndcoslo](https://twitter.com/search?q=%23ndcoslo)|
...
| Wintellect 網路研討會： 簡介 tooAzure DocumentDB| [Josh Lane](https://twitter.com/jplane)|線上|2017 年 1 月 12 日東部標準時間 (EST) 下午 1 點|[Azure DocumentDB︰您的雲端動力、異地調整的 NoSQL 超級武器...隱藏在眼前 (英文)](https://www.youtube.com/watch?v=uVcWgIYtBoc)|
...
| [MongoDB World 2016](https://www.mongodb.com/world16) |Kirill Gavrylyuk |紐約州紐約 |2016 年 6 月 28-29 日 |n/a |
...
| [SQL Saturday #434 - Holland 2015](http://www.sqlsaturday.com/434/Sessions/Details.aspx?sid=36413) |Leonard Lobel |荷蘭烏特勒支 |2015 年 9 月 26 日 |[簡介 tooAzure DocumentDB](https://channel9.msdn.com/Blogs/Azure/SQL-Saturday-Holland-2015-Introduction-to-Azure-DocumentDB) |
...
| [白俄羅斯 Azure 使用者群組見面會](https://www.facebook.com/events/786540124800276/) |Alex Zyl |明斯克，白俄羅斯 |2015 年 9 月 9 日 |[簡介 tooDocumentDB 概念概觀，一致性層級，分區化策略](https://www.youtube.com/watch?v=Uc_qwWzJKH8) |
...
| [Build 2015](http://www.buildwindows.com/) |Ryan Crawcour |美國加州舊金山 |2015 年 4 月 29 日至 5 月 1 日 |[建置 hello 下一個大工作，並使用 Azure 的 NoSQL 服務： DocumentDB](https://channel9.msdn.com/Events/Build/2015/2-729) |
...
| [TechX Azure](https://www.youtube.com/channel/UCDRlI2E4z5qmHsBXTrFOE2Q) |Magnus Mårtensson |瑞典斯德哥爾摩 |2015 年 1 月 28-29 日 |[DocumentDB 中的 hello 雲端 Azure hello 新 NoSQL 選項](https://www.youtube.com/watch?v=Hw7hDYoChNI) |

### <a name="videos-and-podcasts"></a>影片和播客
| 顯示 | 主講人 | 日期 | 劇集 |
| --- | --- | --- | --- |
| Azure Friday |Kirill Gavrylyuk |2016 年 10 月 31 日 |[Azure DocumentDB 有哪些新功能？](https://channel9.msdn.com/Shows/Azure-Friday/AzureFridayNewinDocumentDB) |
| Channel 9︰Microsoft + 開放原始碼 |Jose Miguel Parrella |2016 年 4 月 14 日 |[從 Azure Bitnami、 VM 規模集與 DocumentDB 中的平均 tooDEAN](https://channel9.msdn.com/Blogs/Open/From-MEAN-to-DEAN-in-Azure-with-Bitnami-VM-Scale-Sets-and-DocumentDB) |
...
| hello Azure 播客 |Cale Teeter |2016 年 1 月 14 日 |[第 110 集：使用 DocumentDB 與搜尋](http://azpodcast.azurewebsites.net/post/Episode-110-Using-DocumentDB-Search) |
| 第 9 頻道：現代化應用程式 |Tara Shankar Jana |2016 年 12 月 13 日 |[在您的應用程式採用最新方法 toodata](https://channel9.msdn.com/Series/Modern-Applications/Take-a-modern-approach-to-data-in-your-apps) |
...
| Microsoft Cloud 節目 - 播客 |Andrew Liu |2015 年 9 月 30 日 |[099 集 - 與 Andrew Liu 暢談 Azure DocumentDB](http://www.microsoftcloudshow.com/podcast/Episodes/099-azure-documentdb-with-andrew-liu) |
| .NET Rocks!  - 播客 |Ryan Crawcour |2015 年 9 月 29 日 |[Data on DocumentDB with Ryan CrawCour](https://www.dotnetrocks.com/?show=1197) |
| Data Exposed |Ryan Crawcour |2015 年 9 月 28 日 |[公開上市後的 Azure DocumentDB 新功能](https://channel9.msdn.com/Shows/Data-Exposed/Whats-New-with-Azure-DocumentDB-Since-GA) |
| hello Azure 播客 |Cale Teeter |2015 年 9 月 17 日 |[第 94 集：azpodcast.com re-architecture](http://azpodcast.azurewebsites.net/post/Episode-94-azpodcastcom-re-architecture) |
| 雲端報導 |Ryan Crawcour |2015 年 9 月 4 日 |[第 185 集：DocumentDB Updates with Ryan CrawCour](https://channel9.msdn.com/Shows/Cloud+Cover/Episode-185-DocDB-Updates-with-Ryan-CrawCour) |
| CodeChat 033 |Greg Doerr |2015 年 7 月 28 日 |[Greg Doerr on Azure DocumentDB](https://channel9.msdn.com/Shows/codechat/033) |
| NoSql Central |King Wilder |2015 年 5 月 25 日 |[高爾夫球追蹤器-如何的視訊概觀 toobuild AngularJS、 WebApi 2 和 DocumentDB 的 web 應用程式。](http://www.nosqlcentral.net/Story/Details/videos/kahanu/1-documentdb-golf-tracker-overview) |
| In-Memory Technologies PASS Virtual Chapter |Stephen Baron |2015 年 5 月 25 日 |[歡迎使用 DocumentDB](https://www.youtube.com/watch?v=itFXQCd9-dI) |
| Data Exposed |Ryan Crawcour |2015 年 4 月 8 日 |[DocumentDB 公開上市版及新功能！](https://channel9.msdn.com/Shows/Data-Exposed/DocumentDB-General-Availability-and-Whats-New) |
| Data Exposed |Andrew Liu |2015 年 3 月 17 日 |[Java SDK for DocumentDB](https://channel9.msdn.com/Shows/Data-Exposed/Java-SDK-for-DocumentDB) |
...
| Data Architecture Virtual Chapter PASS |Ike Ellis |2015 年 2 月 25 日 |[簡介 tooDocumentDB](https://www.youtube.com/watch?v=7BQYdFUkz6s) |

### <a name="online-classes"></a>線上課程
| 學習合作夥伴 | 說明 |
| --- | --- |
| [![Microsoft Virtual Academy](./media/community/mva.png)](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) |[**Microsoft Virtual Academy** ](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847)提供協助您建立 Azure DocumentDB 的 hello 人從定型集。 |
| [![Pluralsight](./media/community/pluralsight.png)](http://www.pluralsight.com/courses/azure-documentdb-introduction) |[**Pluralsight**](http://www.pluralsight.com/courses/azure-documentdb-introduction) 是提供 Azure 訓練的主要 Microsoft 合作夥伴。 如果您是 MSDN 訂閱者時，使用程式的優點 tooaccess Microsoft Azure 訓練。 |
| [![OpsGility](./media/community/opsgility.png)](https://www.opsgility.com/courses/player/introduction_to_azure_documentdb) |[**OpsGility**](https://www.opsgility.com/courses/player/introduction_to_azure_documentdb) 提供深入的 Microsoft Azure 的技術訓練。 由導師現場授課，或由業界的專家指導員透過遠距教學授課。 |

## <a name="discussion"></a>討論區
### <a name="twitter"></a>Twitter
在 twitter 上關注我們[ @DocumentDB ](https://twitter.com/DocumentDB)且仍持續與 hello 最新的交談上 hello toodate 向上[#DocumentDB](https://twitter.com/hashtag/DocumentDB)雜湊標記。

### <a name="online-forums"></a>線上論壇
| 論壇提供者 | 說明 |
| --- | --- |
| [![StackOverflow](./media/community/stack-overflow.png)](http://stackoverflow.com/questions/tagged/azure-documentdb) |適用於程式設計人員的共同編輯問題和答案網站 (與語言無關)。 請追隨我們的標記︰ [azure-documentdb](http://stackoverflow.com/questions/tagged/azure-documentdb) |

## <a name="contact-hello-team"></a>連絡 hello 小組
![小組](./media/community/team.png)

您需要技術協助嗎？ 有任何疑問嗎？ 想知道 NoSQL 是否適合您嗎？ 您可以排程直接與 hello DocumentDB 工程團隊 1:1 聊天室調查表[電子郵件](mailto:askcosmosdb@microsoft.com)或 tweeting 我們[ @DocumentDB ](https://twitter.com/DocumentDB)。

## <a name="open-source-projects"></a>開放原始碼專案
這些專案均為 hello Azure DocumentDB 小組中共同作業與我們的開放原始碼社群主動開發。
...
Azure Cosmos DB 精靈是已經示範過其他人取得仿效承諾 toohelping 社群領導人建立 hello 最不足以 Azure Cosmos DB，其體驗 hello Azure DocumentDB 的下一個層代。 它們共用其例外狀況的熱情、 實際知識和技術專業能力與 hello 社群以及 hello Azure Cosmos DB 團隊。
...
想 toobecome Azure Cosmos DB 精靈嗎？ 任何基準測試成為精靈時，我們評估 hello 準則包括 hello 影響 stackoverflow 文章和 MSDN; 例如大法官比重 tooonline 論壇wiki 和線上內容。所做的心得和使用者群組。播客、 網站、 部落格和社交媒體。和文件和活頁簿。 如果您想提名自己或其他人，請 [傳送電子郵件給我們](mailto:askcosmosdb@microsoft.com)。
