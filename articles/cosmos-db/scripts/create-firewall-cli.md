...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure Cosmos DB： 建立使用 Azure CLI hello 的防火牆
...
| [az cosmosdb update](https://docs.microsoft.com/cli/azure/cosmosdb#update) | 更新 Azure CosmosDB 帳戶 tooinclude 防火牆設定。 |
