...
---
# <a name="regenerate-an-azure-cosmos-db-account-key-using-hello-azure-cli"></a>重新產生使用 Azure CLI hello Azure Cosmos DB 帳戶金鑰

這個範例會重新產生的任何一種使用 Azure CLI hello Azure Cosmos DB 帳戶金鑰。 
