...
---
# <a name="azure-cosmos-db-create-an-documentdb-api-account-using-cli"></a>Azure Cosmos DB：使用 CLI 建立 DocumentDB API 帳戶

這個範例 CLI 指令碼會建立 Azure Cosmos DB DocumentDB API 帳戶、資料庫和集合。  
