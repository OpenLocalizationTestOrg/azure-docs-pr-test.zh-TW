...
|[建立 DocumentDB API、圖形或資料表 API 帳戶](scripts/create-database-account-collections-cli.md?toc=%2fcli%2fazure%2ftoc.json)| 建立單一 Azure Cosmos DB API 帳戶、資料庫和容器，以便與 DocumentDB、圖形或資料表 API 搭配使用。 |
