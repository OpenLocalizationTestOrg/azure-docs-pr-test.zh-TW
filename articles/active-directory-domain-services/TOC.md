...
# 開始使用
## Azure 傳統入口網站
### [工作 1： 建立 hello 系統管理員群組](active-directory-ds-getting-started-create-group.md)
...
#### [工作 2： 匯出 hello 安全 LDAP 的憑證](active-directory-ds-admin-guide-configure-secure-ldap-export-pfx.md)
#### [工作 3： 啟用安全 LDAP 的 hello 受管理的網域，使用 Azure 傳統入口網站](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps-classic.md)
#### [工作 3： 啟用安全 LDAP 的 hello 受管理的網域，使用 Azure 入口網站 （預覽）](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps.md)
...
### [啟用 hello 預覽 Azure 入口網站體驗](active-directory-ds-azure-portal-enable-preview-access.md)
