...
### iOS
#### [使用 MSAL 的 iOS Swift](https://github.com/Azure-Samples/active-directory-b2c-ios-swift-native-msal)
#### [使用 AppAuth 的 iOS ObjC](active-directory-b2c-devquickstarts-ios.md)
### Android
#### [使用 MSAL 的 Android](https://github.com/Azure-Samples/active-directory-b2c-android-native-msal)
#### [使用 AppAuth 的 Android](active-directory-b2c-devquickstarts-android.md)
...
## Web 應用程式
### [概觀](active-directory-b2c-reference-oidc.md)
...
## 單一頁面應用程式
### [概觀](active-directory-b2c-reference-spa.md)
### [使用 MSAL 的 JavaScript](https://github.com/Azure-Samples/active-directory-b2c-javascript-msal-singlepageapp)
...
## [使用 hello Azure AD Graph API](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [自訂 hello UI](active-directory-b2c-reference-ui-customization.md)
...
## [使用 hello 報告 API](active-directory-b2c-reference-usage-reporting-api.md)
## [設定自助密碼重設](active-directory-b2c-reference-sspr.md)

# 身分識別體驗架構
## [自訂原則](active-directory-b2c-overview-custom.md)
## 手冊
### [快速入門](active-directory-b2c-get-started-custom.md)
### 設定 OIDC/OAUTH2 提供者
