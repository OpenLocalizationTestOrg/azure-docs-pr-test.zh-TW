...
### [附加的受管理的磁碟 tooa Windows VM 使用 PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [匿名存取 tooblobs](storage-manage-access-to-resources.md)
...
### [移轉 Azure Vm tooAzure 管理磁碟](../virtual-machines/windows/migrate-to-managed-disks.md)
### [從 AWS 和其他平台移轉 tooManaged 磁碟](../virtual-machines/windows/on-prem-to-azure.md)
### [關於 Azure IaaS VM 磁碟 的常見問題](storage-faq-for-disks.md)
### 進階儲存體
#### [VM 磁碟適用的高效能進階儲存體](storage-premium-storage.md)
#### [移轉 tooPremium 使用 「 Azure 站台復原的儲存體](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
#### [為高效能而設計](storage-premium-storage-performance.md)
### 標準儲存體
#### [符合成本效益的標準儲存體和非受控和受控 VM 磁碟](storage-standard-storage.md)
### 使用非受控磁碟
#### [移轉 tooPremium 儲存體](storage-migration-to-premium-storage.md)
...
### [使用 hello 儲存體模擬器](storage-use-emulator.md)
...
## 傳送資料
### [移動資料 tooand 從儲存體](storage-moving-data.md)
### [AzCopy on Windows](storage-use-azcopy.md)
### [AzCopy on Linux](storage-use-azcopy-linux.md)
### [使用 hello 匯入/匯出服務](storage-import-export-service.md)
### [使用 hello 匯入/匯出工具](storage-import-export-tool-how-to.md)
#### [設定 hello 匯入/匯出工具](storage-import-export-tool-setup.md)
...
#### [疑難排解 hello 匯入/匯出工具](storage-import-export-tool-troubleshooting-v1.md)
...
### [使用 hello 匯入/匯出工具 (v1)](storage-import-export-tool-how-to-v1.md)
#### [設定 hello 匯入/匯出工具](storage-import-export-tool-setup-v1.md)
...
#### [匯入/匯出服務中繼資料和屬性檔案格式](storage-import-export-file-format-metadata-and-properties.md)
#### [匯入/匯出服務記錄檔格式](storage-import-export-file-format-log.md)
### [使用 hello Azure 匯入/匯出服務 REST API](storage-import-export-using-the-rest-api.md)
