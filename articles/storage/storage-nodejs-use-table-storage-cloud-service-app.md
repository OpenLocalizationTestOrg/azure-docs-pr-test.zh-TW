...
在本節中，您將藉著新增 **task.js** 檔案的方式擴充由 **express** 命令建立的基本應用程式 (task.js 檔案包含工作的模型)。 您也將修改現有 **app.js** 及建立新的 **tasklist.js** 檔案，以使用模型。
...
和之前一樣，因為您指定 **-launch** 選項，所以當發佈完成時，瀏覽器便會開啟並顯示在 Azure 中執行的應用程式。
