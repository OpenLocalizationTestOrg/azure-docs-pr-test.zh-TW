...
建立 hello 儲存體帳戶的內容。 hello 內容封裝 hello 儲存體帳戶名稱和帳戶金鑰。 如需有關您的帳戶金鑰複製 hello 指示[Azure 入口網站](https://portal.azure.com)，請參閱[檢視與複製的儲存體存取金鑰](storage-create-storage-account.md#view-and-copy-storage-access-keys)。
