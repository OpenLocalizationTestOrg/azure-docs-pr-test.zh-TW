...
如需有關指示 toocreate Node.js 應用程式，請參閱 [建立 Azure App Service 中的 Node.js web 應用程式]、[建置和部署 Azure 雲端服務的 Node.js 應用程式 tooan](../../cloud-services/cloud-services-nodejs-develop-deploy-app.md) -使用 Windows PowerShell 或[建置和部署使用 Web Matrix Node.js web 應用程式 tooAzure](https://www.microsoft.com/web/webmatrix/)。
...
如需設定 hello hello 環境變數的範例[Azure 入口網站](https://portal.azure.com)Azure web 應用程式中，請參閱[Node.js web 應用程式使用 hello Azure 資料表服務](../../app-service-web/storage-nodejs-use-table-storage-web-site.md)。
...
[建置和部署使用 Web Matrix Node.js web 應用程式 tooAzure]: https://www.microsoft.com/web/webmatrix/  
