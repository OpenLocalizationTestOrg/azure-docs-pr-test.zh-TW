...
您可以選擇哪些每小時度量您想要在 hello toodisplay [Azure 入口網站](https://portal.azure.com)並設定每小時度量超過特定閾值時，透過電子郵件通知系統管理員的規則。 如需詳細資訊，請參閱[接收警示通知](/azure/monitoring-and-diagnostics/monitoring-overview-alerts.md)。 
