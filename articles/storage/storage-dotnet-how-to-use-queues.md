...
* 檢視有關將資料儲存在 Azure 中的其他選項的詳細功能指南 toolearn。
  * [開始使用適用於.NET 的 Azure 資料表儲存體使用](storage-dotnet-how-to-use-tables.md)toostore 結構化資料。
  * [開始使用適用於.NET 的 Azure Blob 儲存體使用](storage-dotnet-how-to-use-blobs.md)toostore 非結構化的資料。
