---
title: "aaaAzure 備份文件-教學課程中，API 參考 |Microsoft 文件"
description: "使用備份文件 toolearn 如何向上 toohello tooback 雲端。 請參閱應用程式、Windows Server 和 Azure 虛擬機器備份的教學課程和影片。"
services: backup
author: carolz
manager: carolz
layout: LandingPage
...
了解如何在 hello toouse Azure Backup 雲端 tooprotect 長期保存和復原的資料。 教學課程、 影片和其他文件告訴您如何 tooback 資料、 應用程式、 Windows server 和 Azure 虛擬機器。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure 備份伺服器開始備份 VMware 伺服器</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Azure 備份開始保護 Azure 虛擬機器</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">復原服務 REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
