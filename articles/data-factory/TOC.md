# 概觀
## [簡介 tooAzure Data Factory](data-factory-introduction.md)
## 概念
...
# 開始使用
## [教學課程： 建立管線 toocopy 資料](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)
...
## [教學課程： 建立管線 tootransform 資料](data-factory-build-your-first-pipeline.md)
...
#### [逐步解說： 將資料從內部部署 SQL Server tooAzure Blob 儲存體移](data-factory-move-data-between-onprem-and-cloud.md)
