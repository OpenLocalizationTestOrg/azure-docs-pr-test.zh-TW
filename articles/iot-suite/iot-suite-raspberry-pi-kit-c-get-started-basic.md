...
---
# <a name="connect-your-raspberry-pi-3-toohello-remote-monitoring-solution-and-send-telemetry-from-a-real-sensor-using-c"></a>連接遠端監視解決方案程式覆盆子 Pi 3 toohello 並傳送遙測，從使用 C 真實感應器
