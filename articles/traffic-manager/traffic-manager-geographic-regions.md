...
本文列出 hello 國家 / 地區使用 hello**地理**流量路由方法 Azure Traffic Manager 中。 您也可以用程式設計方式呼叫 [ Azure 流量管理員的 REST API](https://docs.microsoft.com/rest/api/trafficmanager/)，以取得這項資訊。 
