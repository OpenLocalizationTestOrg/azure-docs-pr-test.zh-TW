...
現在，我們已經 hello 資訊所需 toorun hello 指令程式，我們會執行 hello `az network watcher test-ip-flow` cmdlet tootest hello 流量。 在此範例中，我們會使用第一個 IP 位址 hello hello 第一個 NIC 上
...
執行之後`az network watcher test-ip-flow`hello 結果、 hello 下列範例是 hello hello 前面步驟所傳回的結果。
