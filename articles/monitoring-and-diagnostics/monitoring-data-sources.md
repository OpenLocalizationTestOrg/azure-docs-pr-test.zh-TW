...
Hello Azure 跨平台，我們想要攜帶一起監視與 hello Azure 監視器管線，在單一位置的資料，但實際上了解目前並非所有的監視資料可用該管線中尚未。 在本文中，我們將摘要說明您可以程式設計方式從 Azure 服務存取監視資料的各種方式 hello。
...
- 深入了解[hello Azure 活動記錄檔](monitoring-overview-activity-logs.md)
