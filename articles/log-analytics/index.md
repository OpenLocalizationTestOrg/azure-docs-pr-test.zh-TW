---
title: "Azure Log Analytics 文件 - 教學課程和 API 參考 | Microsoft Docs"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始在 Log Analytics 中進行 Proxy 和防火牆設定</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/loganalytics">REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
