...
## 管理
###[Hello 入口網站設定](cache-configure.md)
...
## 監視及疑難排解
###[在 hello 入口網站中監視](cache-how-to-monitor.md)
###[快取問題進行疑難排解](cache-how-to-troubleshoot.md)
###[為例外狀況設定警示](cache-how-to-monitor.md#operations-and-alerts)
## 調整
###[更新 tooa 不同大小和層](cache-how-to-scale.md)
###[使用 Redis 叢集 tooscale in/out](cache-how-to-premium-clustering.md)
## 與 Spring Boot 整合
###[使用 Spring Boot Initializer 應用程式搭配 Redis Cache](cache-java-spring-boot-initializer-with-redis-cache.md)
