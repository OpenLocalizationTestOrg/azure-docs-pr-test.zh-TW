...
建立並複製 AWS 安全性金鑰後，您必須使用 Azure 自動化帳戶建立認證資產以安全地儲存金鑰，並讓金鑰與 Runbook 參照。  按照 [Azure 自動化中的認證資產](automation-credentials.md#to-create-a-new-credential-asset-with-the-azure-portal)一文中**建立新認證**一節的步驟來進行，並輸入下列資訊︰
