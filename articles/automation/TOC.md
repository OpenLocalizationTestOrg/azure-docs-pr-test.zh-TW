...
### [建立自動化執行身分帳戶](automation-create-runas-account.md)
...
### [傳遞 JSON 物件 tooan Azure 自動化 runbook](automation-pass-json-string.md)
...
### [轉送 Azure 自動化 DSC 報告資料 tooOMS 記錄分析](automation-dsc-diagnostics.md)
## 管理資產
...
## 監視
### [正向 Azure 自動化工作資料 tooLog 分析](automation-manage-send-joblogs-log-analytics.md)
