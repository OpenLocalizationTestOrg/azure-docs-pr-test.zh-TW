...
# 開始使用
## [佈建 hello Azure 入口網站中的 VM](virtual-machines-windows-portal-sql-server-provision.md)
## [使用 Azure PowerShell 佈建 VM](virtual-machines-windows-ps-sql-create.md)
## [連接 tooa VM](virtual-machines-windows-sql-connect.md)
...
## 管理
### [使用 SQL Server IaaS 代理程式延伸模組 hello](virtual-machines-windows-sql-server-agent-extension.md)
