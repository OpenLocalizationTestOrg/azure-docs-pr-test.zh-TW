...
---
# <a name="quick-create-a-virtual-machine-with-hello-azure-cli"></a>快速建立虛擬機器以 hello Azure CLI

此指令碼會建立執行 Windows Server 2016 的 Azure 虛擬機器。 執行 hello 指令碼之後, 您可以透過遠端桌面連線存取 hello 虛擬機器。
