...
Microsoft 在 2016 年 9 月發行的功能，可讓您使用 [Azure 內部負載平衡器][load-balancer-multivip-overview]管理多個虛擬 IP 位址。 這項功能已存在於 hello Azure 外部負載平衡器。
...
> [!NOTE]
> 只有在 hello Azure Resource Manager 部署模型中使用這項功能。
...
4. [安裝 hello 資料庫執行個體][sap-ha-guide-9.2]。  
 在此步驟中，您要在專用的 WSFC 叢集上安裝 DBMS。

5. [安裝第二個叢集節點 hello][sap-ha-guide-9.3]。  
