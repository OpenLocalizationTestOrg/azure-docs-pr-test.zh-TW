---
title: "aaaLinux Azure VM 大小的記憶體 |Microsoft 文件"
description: "列出 hello 不同記憶體最佳化的可用在 Azure 中 Linux 虛擬機器的大小。"
...
---
# <a name="memory-optimized-linux-vm-sizes"></a>記憶體最佳化 Linux VM 大小
...
- [一般用途](../windows/sizes-general.md)
- [計算最佳化](../windows/sizes-compute.md)
- [儲存體最佳化](sizes-storage.md)
- [GPU](../windows/sizes-gpu.md)
- [高效能計算](../windows/sizes-hpc.md)
