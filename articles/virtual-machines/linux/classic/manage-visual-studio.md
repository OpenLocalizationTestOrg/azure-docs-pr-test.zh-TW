...
---
# <a name="create-and-manage-linux-virtual-machines-in-visual-studio"></a><span data-ttu-id="bfaed-103">在 Visual Studio 中建立和管理 Linux 虛擬機器</span><span class="sxs-lookup"><span data-stu-id="bfaed-103">Create and manage Linux virtual machines in Visual Studio</span></span>
