...
在此教學課程中，您學會如何 toointegrate Bime 與 Azure Active Directory (Azure AD)。

整合 Azure AD 與 Bime 可以提供下列優點 hello:

- 您可以控制存取 tooBime Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooBime （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 Bime 的整合，您需要下列項目 hello:
...
## <a name="adding-bime-from-hello-gallery"></a>從 hello 圖庫加入 Bime
tooconfigure hello 整合 Bime 的 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd Bime。

**tooadd Bime 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Bime**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-bime-tutorial/tutorial_bime_search.png)

5. 在 [hello [結果] 窗格中，選取 [ **Bime**，然後按一下 [**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-bime-tutorial/tutorial_bime_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 Bime 設定及測試 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 Bime 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 Bime 中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

在 Bime 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 Bime，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Bime](#creating-a-bime-test-user) ** -toohave 許 Simon 是連結的 toohello Azure AD 使用者表示法的 Bime 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Bime 的應用程式中。

**tooconfigure Azure AD 單一登入 Bime 中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Bime**應用程式整合頁面上，按一下 [**單一登入**。
...
3. 在 [hello **Bime 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-bime-tutorial/tutorial_bime_url.png)

    a. 在 [hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenant-name>.Bimeapp.com`

    b. 在 [hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenant-name>.Bimeapp.com`

    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello 登入 URL 和識別項。 請連絡[Bime 用戶端支援小組](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-)tooget 這些值。 
...
6. 在 [hello **Bime 組態**區段中，按一下**設定 Bime** tooopen**設定登入**視窗。 複製 hello **SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-bime-tutorial/tutorial_bime_configure.png) 

7. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 Bime 公司網站。

8. 在 [hello] 工具列中，按一下 [ **Admin**，然後**帳戶**。
...
### <a name="creating-a-bime-test-user"></a>建立 Bime 測試使用者

在訂單 tooenable Azure AD 使用者 toolog tooBime 中，您必須是佈建到 Bime。 在 Bime 的 hello 案例中，佈建須手動進行。

**tooconfigure 使用者佈建，執行下列步驟的 hello:**

1. 登入 tooyour **Bime**租用戶。

2. 在 [hello] 工具列中，按一下 [ **Admin**，然後**使用者**。
   
    ![管理](./media/active-directory-saas-bime-tutorial/ic775561.png "管理")

3. 在 [hello**使用者清單**，按一下 [**新增使用者**（"+"）。
   
    ![使用者](./media/active-directory-saas-bime-tutorial/ic775562.png "使用者")

4. 在 [hello**使用者詳細資料**對話方塊頁面上，執行下列步驟的 hello:
...
>[!NOTE]
>您可以使用任何其他 Bime 使用者帳戶建立工具或 Api 提供 Bime tooprovision AAD 使用者帳戶。
>  

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooBime 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooBime，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 [**所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Bime**。
...
當您按一下 hello Bime 磚 hello 存取面板中的時，您應該取得 tooyour 自動登入 Bime 的應用程式。
