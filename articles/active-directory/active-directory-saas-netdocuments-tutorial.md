...
在此教學課程中，您學會如何 toointegrate NetDocuments 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 NetDocuments 可以提供下列優點 hello:

- 您可以控制存取 tooNetDocuments Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooNetDocuments （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與 NetDocuments 的 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 NetDocuments 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 NetDocuments
2. 設定並測試 Azure AD 單一登入

## <a name="adding-netdocuments-from-hello-gallery"></a>從 hello 圖庫加入 NetDocuments
tooconfigure hello 整合 NetDocuments 的 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd NetDocuments。

**tooadd NetDocuments 從 hello 組件庫中，執行下列步驟的 hello:**
...
在本節中，您會以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 NetDocuments 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 NetDocuments 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello NetDocuments 中相關的使用者之間的連結關聯性需要 toobe 建立。

在 NetDocuments 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 NetDocuments，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 NetDocuments](#creating-a-netdocuments-test-user)**  -toohave 許 Simon NetDocuments 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 NetDocuments 應用程式中。

**tooconfigure Azure AD 單一登入 NetDocuments，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **NetDocuments**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **NetDocuments 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-netdocuments-tutorial/tutorial_netdocuments_url.png)

    a. 在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://vault.netvoyage.com/neWeb2/docCent.aspx?whr=<user identifier>`

    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://vault.netvoyage.com/neWeb2/docCent.aspx?whr=<user identifier>`

    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與 hello 實際登入 URL 和回覆 URL。 請連絡[NetDocuments 支援小組](https://support.netdocuments.com/hc/)tooget 這些值。
...
6. 在不同的 Web 瀏覽器視窗中，以系統管理員身分登入您的 NetDocuments 公司網站。
...
### <a name="creating-a-netdocuments-test-user"></a>建立 NetDocuments 測試使用者

tooenable Azure AD 使用者 toolog 中 tooNetDocuments，它們必須佈建到 NetDocuments。  
在 NetDocuments 的 hello 案例中，佈建須手動進行。

**tooprovision 使用者帳戶，執行下列步驟的 hello:**

1. 登入 tooyour **NetDocuments**以系統管理員身分的公司網站。
...
4. 在 hello**電子郵件地址**文字方塊中，您想 tooprovision，然後再按一下之有效 Azure Active Directory 帳戶類型 hello 電子郵件地址**新增使用者**。
   
    ![電子郵件地址](./media/active-directory-saas-netdocuments-tutorial/ic795053.png "電子郵件地址")
   
   >[!NOTE]
   >hello Azure Active Directory 帳戶持有者會收到電子郵件，其中包含連結 tooconfirm hello 帳戶之前就會生效。 您可以使用任何其他 NetDocuments 使用者帳戶建立工具或 Api 提供 NetDocuments tooprovision Azure Active Directory 使用者帳戶。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooNetDocuments 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooNetDocuments，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**NetDocuments**。
...
當您按一下的 hello NetDocuments 磚 hello 存取面板中時，您應該取得自動登入 tooyour NetDocuments 的應用程式。
