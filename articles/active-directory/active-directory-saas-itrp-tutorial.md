...
在此教學課程中，您學會如何 toointegrate ITRP 與 Azure Active Directory (Azure AD)。

整合 Azure AD 與 ITRP 可以提供下列優點 hello:

- 您可以控制存取 tooITRP Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooITRP （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 ITRP 的整合，您需要下列項目 hello:
...
## <a name="adding-itrp-from-hello-gallery"></a>從 hello 圖庫加入 ITRP
tooconfigure hello 整合 ITRP tooAzure AD 中的，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd ITRP。

**tooadd ITRP 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**ITRP**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_search.png)

5. 在 [hello [結果] 窗格中，選取 [ **ITRP**，然後按一下 [**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入

在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 ITRP 設定及測試 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 ITRP 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 ITRP 中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

在 ITRP 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 ITRP，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立 ITRP 測試使用者](#creating-an-itrp-test-user)** -toohave 許 Simon 是連結的 toohello Azure AD 使用者表示法的 ITRP 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 ITRP 的應用程式中。

**tooconfigure Azure AD 單一登入 ITRP 中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **ITRP**應用程式整合頁面上，按一下 [**單一登入**。
...
3. 在 [hello **ITRP 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_url.png)

    a. 在 [hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenant-name>.itrp.com`

    b. 在 [hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenant-name>.itrp.com`

    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello 登入 URL 和識別項。 請連絡[ITRP 用戶端支援小組](https://www.itrp.com/support)tooget 這些值。 
...
6. 在 [hello **ITRP 組態**區段中，按一下**設定 ITRP** tooopen**設定登入**視窗。 複製 hello **SAML 單一登入服務 URL 和登出 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-itrp-tutorial/tutorial_itrp_configure.png) 

7. 在不同的網頁瀏覽器視窗中，系統管理員身分登入 tooyour ITRP 公司網站。

8. 在 hello hello 上方的工具列中按一下**設定**。
   
    ![ITRP](./media/active-directory-saas-itrp-tutorial/ic775570.png "ITRP")

8. 在 [hello 左側瀏覽窗格中，選取**單一登入**。
   
    ![單一登入](./media/active-directory-saas-itrp-tutorial/ic775571.png "單一登入")

9. 在 hello 單一登入的組態區段中，執行下列步驟的 hello:
    ...
    b. 在**遠端登出 URL**文字方塊中，貼上 hello 值**登出 URL**，從 Azure 入口網站複製的。

    c. 在**SAML SSO URL**文字方塊中，貼上 hello 值**SAML 單一登入服務 URL**，從 Azure 入口網站複製的。

    d.In**憑證指紋**文字方塊中，貼上 hello**指紋**憑證，您從 Azure 入口網站複製的值。 
...
### <a name="creating-an-itrp-test-user"></a>建立 ITRP 測試使用者

tooenable Azure AD 使用者 toolog 中 tooITRP，必須將他們佈建 tooITRP 中。  

在 ITRP 的 hello 案例中，佈建須手動進行。

**tooprovision 使用者帳戶，執行下列步驟的 hello:**

1. 登入 tooyour **ITRP**租用戶。

2. 在 hello hello 上方的工具列中按一下**記錄**。
   
    ![管理](./media/active-directory-saas-itrp-tutorial/ic775575.png "管理")

3. 從 hello 快顯功能表中，選取**人員**。
...
5. 在 hello 新增人員] 對話方塊中，執行下列步驟的 hello:
   
    ![使用者](./media/active-directory-saas-itrp-tutorial/ic775577.png "使用者") 
      
    a. 型別 hello**名稱**，**電子郵件**想 tooprovision 之有效 AAD 帳戶。

    b. 按一下 [儲存] 。

>[!NOTE]
>您可以使用任何其他 ITRP 使用者帳戶建立工具或 Api 提供 ITRP tooprovision AAD 使用者帳戶。 
> 

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooITRP 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooITRP，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 [**所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**ITRP**。
...
當您按一下的 hello ITRP 磚 hello 存取面板中時，您應該取得 tooyour 自動登入 ITRP 的應用程式。
