...
---
# <a name="tutorial-azure-active-directory-integration-with-teamwork"></a>教學課程：Azure Active Directory 與 Teamwork 整合

在此教學課程中，您學會如何 toointegrate 團隊與 Azure Active Directory (Azure AD) 的工作。

與 Azure AD 整合團隊工作可以提供下列優點 hello:

- 您可以控制存取 tooTeamwork Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooTeamwork （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與團隊工作的 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Teamwork 單一登入功能的訂用帳戶
...
## <a name="adding-teamwork-from-hello-gallery"></a>從 hello 圖庫加入團隊工作
tooconfigure hello 整合團隊工作到 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd 團隊工作。

**tooadd 團隊工作從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**團隊工作**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_001.png)

5. 在 hello 結果 窗格中，選取 **團隊工作**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_0001.png)


##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 Teamwork 設定及測試 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow 團隊工作中的 hello 對等項目的使用者是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello 團隊工作中的相關的使用者之間的連結關聯性需要 toobe 建立。

此連結關聯性建立 hello 將值指派為 hello**使用者名稱**做為 hello hello 值的 Azure AD 中**Username**團隊工作中。

tooconfigure 及測試 Azure AD 單一登入與團隊工作，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者團隊工作](#creating-a-teamwork-test-user)** -toohave 許 Simon 是連結的 toohello Azure AD 表示她的團隊工作中的對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 管理入口網站中，並設定單一登入您的團隊工作應用程式中。

**tooconfigure Azure AD 單一登入與團隊工作，執行下列步驟的 hello:**

1. 在 hello Azure 管理入口網站上 hello**團隊工作**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello**團隊工作網域和 Url**區段中的，在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<company name>.teamwork.com`

    ![設定單一登入](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_02.png)

    > [!NOTE] 
    > 請注意，這不是 hello 真正的價值。 您有的 tooupdate 這個值與實際的 hello 登入 URL。 請連絡[團隊工作支援小組](mailto:support@teamwork.com)tooget 此值。 
...
9. tooget SSO 設定應用程式，請連絡[團隊工作支援小組](mailto:support@teamwork.com)並提供給他們，以下載 hello**中繼資料**。
...
### <a name="creating-a-teamwork-test-user"></a>建立 Teamwork 測試使用者

在本節中，您要在 Teamwork 中建立名為 Britta Simon 的使用者。 請使用[團隊工作支援小組](mailto:support@teamwork.com)tooadd hello hello 團隊工作平台的使用者。


### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與他們存取 tooTeamwork 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooTeamwork，執行下列步驟的 hello:**

1. 在 hello Azure 管理入口網站中，開啟 hello 應用程式 檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**團隊工作**。
...
當您按一下 hello 團隊工作並排顯示 hello 存取面板中的時，您應該取得自動登入 tooyour 團隊工作應用程式。
