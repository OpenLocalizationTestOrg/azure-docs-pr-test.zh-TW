...
在此教學課程中，您學會如何 toointegrate Oneteam 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Oneteam 可以提供下列優點 hello:

- 您可以控制存取 tooOneteam Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooOneteam （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Oneteam 與 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Oneteam 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 Oneteam
2. 設定並測試 Azure AD 單一登入

## <a name="adding-oneteam-from-hello-gallery"></a>從 hello 圖庫加入 Oneteam
tooconfigure hello 整合 Oneteam 到 Azure AD，您需要 tooadd Oneteam hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Oneteam 從 hello 組件庫中，執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 Oneteam 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Oneteam 中相關的使用者之間的連結關聯性需要 toobe 建立。

Oneteam 中, 指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 Oneteam 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Oneteam](#creating-a-oneteam-test-user)**  -toohave 許 Simon Oneteam 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 Oneteam 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 Oneteam，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Oneteam**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Oneteam 網域和 Url**區段中，如果您想 tooconfigure hello 應用程式中的**IDP**初始模式：

    ![設定單一登入](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_url.png)

    a. 在 hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://api.one-team.io/teams/<team name>`

    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://api.one-team.io/teams/<team name>/auth/saml/callback`
...
4. 請檢查**顯示進階的 URL 設定**，如果您想 tooconfigure hello 應用程式中的**SP**初始模式：
    ...
    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<team name>.one-team.io/`
     
    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello，識別項、 回覆 URL 和登入 URL。 請連絡[Oneteam 用戶端支援小組](https://support.one-team.com/hc/requests/new)tooget 這些值。 
...
7. tooget SSO 設定應用程式，您可以提高 hello 支援票證給[Oneteam 支援小組](https://support.one-team.com/hc/requests/new)並提供給他們 hello 下載**中繼資料**。 
...
hello 本節目標在於 toocreate Oneteam 中呼叫許 Simon 的使用者。 Oneteam 支援預設啟用的 Just-In-Time 佈建。

在這一節沒有您需要進行的動作項目。 如果尚未存在，將期間嘗試 tooaccess Oneteam，建立新的使用者。

>[!NOTE]
>若要手動 toocreate 使用者，您可以提高 hello 支援票證給[Oneteam 支援小組](https://support.one-team.com/hc/requests/new)。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooOneteam 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooOneteam，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Oneteam**。
...
當您按一下 hello Oneteam 磚 hello 存取面板中的時，您應該取得自動登入 tooyour Oneteam 應用程式。
