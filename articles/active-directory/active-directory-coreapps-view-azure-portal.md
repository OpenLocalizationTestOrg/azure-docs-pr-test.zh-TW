...
您可以在 Azure Active Directory (Azure AD) 中，管理您的企業應用程式。 這包括檢視您可以管理的應用程式、將使用者或群組指派給應用程式、維護應用程式的屬性 (例如應用程式名稱/標誌)，甚至是停用應用程式，讓任何使用者都無法登入。

## <a name="how-do-i-view-all-my-apps"></a>如何檢視我的所有應用程式？
