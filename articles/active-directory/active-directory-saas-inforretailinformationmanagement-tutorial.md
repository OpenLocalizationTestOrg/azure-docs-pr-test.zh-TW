...
在此教學課程中，您學會如何 toointegrate 資訊零售 – 資訊管理與 Azure Active Directory (Azure AD)。

整合這些零售 – 資訊管理與 Azure AD 可以提供下列優點 hello:

- 您可以控制存取 tooInfor 零售 – 資訊管理 Azure AD 中。
- 您可以啟用您的使用者 tooautomatically get 登入 tooInfor 零售 – 使用其 Azure AD 帳戶的資訊管理 （單一登入）。
...
tooconfigure 資訊零售 – 資訊管理與 Azure AD 整合您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Infor Retail – Information Management 單一登入的訂用帳戶
...
1. 新增這些零售 – 從 hello 組件庫的資訊管理
2. 設定並測試 Azure AD 單一登入

## <a name="adding-infor-retail--information-management-from-hello-gallery"></a>新增這些零售 – 從 hello 組件庫的資訊管理
tooconfigure hello 整合的資訊零售 – 資訊管理到 Azure AD，您需要 tooadd 資訊零售 – hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式的資訊管理。

**tooadd 資訊零售 – hello 庫、 資訊管理執行下列步驟的 hello:**
...
4. 在 hello 搜尋方塊中，輸入**資訊零售 – 資訊管理**，選取**資訊零售 – 資訊管理**然後按一下 從結果面板**新增**按鈕 tooadd hello應用程式。
...
在本節中，您會以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 Infor Retail – Information Management 搭配運作的 Azure AD 單一登入。

針對單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在這些零售-資訊管理是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello 資訊零售 – 資訊管理相關的使用者之間的連結關聯性需要 toobe 建立。

在這些零售 – Information Management 指派 hello hello 值**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 和測試 Azure AD 單一登入資訊零售 – 資訊管理與您需要遵循的建置組塊 toocomplete hello:
...
3. **[建立這些零售 – 資訊管理測試使用者](#create-an-infor-retail--information-management-test-user)** -toohave 許 Simon 資訊零售中對應項目 – 是表示連結的 toohello Azure AD 使用者的資訊管理。
...
在本節中，您要啟用 Azure AD 單一登入 hello Azure 入口網站中，並在您的資訊零售 – 資訊管理應用程式設定單一登入。

**這些零售 – 資訊管理與 Azure AD 單一登入 tooconfigure 執行 hello 下列步驟：**

1. 在 Azure 入口網站上 hello hello**資訊零售 – 資訊管理**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello**資訊零售 – 資訊管理網域和 Url**區段中，執行下列步驟，如果您想在 IDP tooconfigure hello 應用程式起始模式 hello:
    ...
    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<company name>.mingle.infor.com/sp/ACS.saml2`
...
4. 請檢查**顯示進階的 URL 設定**並執行下列步驟，如果您想 tooconfigure hello 應用程式中的 hello **SP**初始模式：
    ...
    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<company name>.mingle.infor.com/<company code>`
     
    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello，識別項、 回覆 URL 和登入 URL。 請連絡[資訊零售 – 資訊管理用戶端支援小組](mailto:innovate@infor.com)tooget 這些值。 
...
7. tooconfigure 單一登入上**資訊零售 – 資訊管理**端，您需要下載 toosend hello**中繼資料 XML**太[資訊零售 – 資訊管理支援小組](mailto:innovate@infor.com). 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
### <a name="create-an-infor-retail--information-management-test-user"></a>建立 Infor Retail – Information Management 測試使用者

在本節中，您要在 Infor Retail – Information Management 中建立名為 Britta Simon 的使用者。 請使用[資訊零售 – 資訊管理支援小組](mailto:innovate@infor.com)tooadd hello hello 資訊零售 – 資訊管理平台的使用者。

### <a name="assign-hello-azure-ad-test-user"></a>指派給 Azure AD hello 測試使用者

本節中，您可以授與存取 tooInfor 零售 – 資訊管理啟用了許 Simon toouse Azure 單一登入。

![指派 hello 使用者角色][200] 

**tooassign 許 Simon tooInfor 零售 – 資訊管理執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**資訊零售 – 資訊管理**。
...
當您按一下 hello 資訊零售 – hello 存取面板中的資訊管理圖格時，您應該取得自動登入 tooyour 資訊零售 – 資訊管理應用程式。
