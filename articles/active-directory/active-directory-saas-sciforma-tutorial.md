...
在此教學課程中，您學會如何 toointegrate Sciforma 與 Azure Active Directory (Azure AD)。

整合 Azure AD 與 Sciforma 可以提供下列優點 hello:

- 您可以控制存取 tooSciforma Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooSciforma （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 Sciforma 的整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Sciforma 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 Sciforma
2. 設定並測試 Azure AD 單一登入

## <a name="adding-sciforma-from-hello-gallery"></a>從 hello 圖庫加入 Sciforma
tooconfigure hello 整合 Sciforma 的 Azure AD，您需要 tooadd Sciforma hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Sciforma 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Sciforma**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-sciforma-tutorial/tutorial_sciforma_search.png)

5. 在 [hello [結果] 窗格中，選取 [ **Sciforma**，然後按一下 [**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-sciforma-tutorial/tutorial_sciforma_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您將以名為 "Britta Simon" 的測試使用者身分，設定及測試與 Sciforma 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 Sciforma 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Sciforma 中相關的使用者之間的連結關聯性需要 toobe 建立。

Sciforma 中, 指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 Azure AD 單一登入與 Sciforma 的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Sciforma](#creating-a-sciforma-test-user) ** -toohave 許 Simon Sciforma 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Sciforma 的應用程式中。

**tooconfigure Azure AD 單一登入 Sciforma 時，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Sciforma**應用程式整合頁面上，按一下 [**單一登入**。
...
3. 在 [hello **Sciforma 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-sciforma-tutorial/tutorial_sciforma_url.png)

    a. 在 [hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<subdomain>.sciforma.net/sciforma/main.html`

    b. 在 [hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<subdomain>.sciforma.net/sciforma/saml`

    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello 登入 URL 和識別項。 請連絡[Sciforma 用戶端支援小組](http://www.sciforma.com/company/contact_us)tooget 這些值。 
...
6. tooconfigure 單一登入上**Sciforma**端，您需要下載 toosend hello**中繼資料 XML**太[Sciforma 支援小組](http://www.sciforma.com/company/contact_us)。
...
### <a name="creating-a-sciforma-test-user"></a>建立 Sciforma 測試使用者

不沒有您 tooconfigure 使用者佈建 tooSciforma 任何動作項目。 當指派的使用者嘗試 toolog tooSciforma 使用 hello 存取面板中的時，Sciforma 會檢查 hello 使用者是否存在。  

* 如果尚無可用的使用者帳戶，Sciforma 會自動予以建立。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooSciforma 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooSciforma，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 [**所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Sciforma**。
