...
在此教學課程中，您學會如何 toointegrate Inkling 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Inkling 可以提供下列優點 hello:

- 您可以控制存取 tooInkling Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooInkling （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Inkling 與 Azure AD 整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 Inkling
2. 設定並測試 Azure AD 單一登入


## <a name="adding-inkling-from-hello-gallery"></a>從 hello 圖庫加入 Inkling
tooconfigure hello 整合 Inkling 到 Azure AD，您需要 tooadd Inkling hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Inkling hello 圖庫中，從執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 Inkling 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Inkling 中相關的使用者之間的連結關聯性需要 toobe 建立。

此連結關聯性建立 hello 將值指派為 hello**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** Inkling 中。

tooconfigure 及 Inkling 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Inkling](#creating-an-inkling-test-user)**  -toohave 許 Simon 是連結的 toohello Azure AD 表示她的 Inkling 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 管理入口網站中，並 Inkling 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 Inkling，執行下列步驟的 hello:**

1. 在 hello Azure 管理入口網站上 hello **Inkling**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Inkling 網域和 Url**區段中，執行下列步驟的 hello:
    
    ![設定單一登入](./media/active-directory-saas-inkling-tutorial/tutorial_inkling_01.png)

    a. 在 hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://api.inkling.com/saml/v2/metadata/<user-id>`

    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://api.inkling.com/saml/v2/acs/<user-id>`

    > [!NOTE] 
    > 請注意這些不是 hello 實際值。 您有 tooupdate hello 實際的識別項和回覆 url 的這些值。 請連絡[Inkling 支援小組](mailto:press@inkling.com)tooget 這些值。
...
9. tooget SSO 設定應用程式，請連絡[Inkling 支援小組](mailto:press@inkling.com)並提供給他們與下載**中繼資料**。 
...
在本節中，您要在 Inkling 中建立名為 Britta Simon 的使用者。 請使用[Inkling 支援小組](mailto:press@inkling.com)tooadd hello hello Inkling 平台的使用者。


### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與他們存取 tooInkling 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooInkling，執行下列步驟的 hello:**

1. 在 hello Azure 管理入口網站中，開啟 hello 應用程式 檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Inkling**。
...
當您按一下 hello Inkling 磚 hello 存取面板中的時，您應該取得自動登入 tooyour Inkling 應用程式。
