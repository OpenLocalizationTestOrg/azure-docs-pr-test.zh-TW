...
在此教學課程中，您學會如何 toointegrate Abintegro 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Abintegro 可以提供下列優點 hello:

- 您可以控制存取 tooAbintegro Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooAbintegro （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與 Abintegro 的 Azure AD 整合，您需要下列項目 hello:
...
1. 加入從 hello gallery Abintegro
2. 設定並測試 Azure AD 單一登入

## <a name="adding-abintegro-from-hello-gallery"></a>加入從 hello gallery Abintegro
tooconfigure hello 整合 Abintegro 的 Azure AD，您需要 tooadd Abintegro hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Abintegro hello 圖庫中，從執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Abintegro**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_search.png)

5. 在 hello 結果 窗格中，選取  **Abintegro**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者為基礎，設定及測試與 Abintegro 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 對應項目中 Abintegro 的使用者是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Abintegro 中相關的使用者之間的連結關聯性需要 toobe 建立。

Abintegro 中, 指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 Azure AD 單一登入與 Abintegro 的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Abintegro](#creating-an-abintegro-test-user)**  -toohave 許 Simon Abintegro 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Abintegro 的應用程式中。

**tooconfigure Azure AD 單一登入 Abintegro，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Abintegro**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Abintegro 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_url.png)

    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://dev.abintegro.com/Shibboleth.sso/Login?entityID=<Issuer>&target=https://dev.abintegro.com/secure/`

    > [!NOTE] 
    > 這不是真實的值。 更新此值以 hello 實際的登入 URL。 請連絡[Abintegro 用戶端支援小組](mailto:support@abintegro.com)tooget 此值。 
...
6. tooconfigure 單一登入上**Abintegro**端，您需要下載 toosend hello**中繼資料 XML**太[Abintegro 支援小組](mailto:support@abintegro.com)。 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
不沒有您 tooconfigure 使用者佈建 tooAbintegro 任何動作項目。 當指派的使用者嘗試 toolog 入 Abintegro 使用 hello 存取面板時，Abintegro 會檢查 hello 使用者是否存在。
  
如果尚無可用的使用者帳戶，Abintegro 會自動予以建立。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooAbintegro 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooAbintegro，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Abintegro**。
...
當您按一下 hello Abintegro 磚 hello 存取面板中的時，您應該取得 Abintegro 的應用程式的登入頁面。
