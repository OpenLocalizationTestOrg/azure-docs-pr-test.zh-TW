...
在此教學課程中，您學會如何 toointegrate 太平洋時程表與 Azure Active Directory (Azure AD)。

與 Azure AD 整合太平洋時程表可以提供下列優點 hello:

- 您可以控制存取 tooPacific 時程表的 Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooPacific 時程表 （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 太平洋時程表與 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Pacific Timesheet 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入太平洋時程表
2. 設定並測試 Azure AD 單一登入

## <a name="adding-pacific-timesheet-from-hello-gallery"></a>從 hello 圖庫加入太平洋時程表
tooconfigure hello 整合太平洋時程表為 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd 太平洋時程表。

**tooadd 太平洋時程表從 hello 組件庫中，執行下列步驟的 hello:**
...
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 Pacific Timesheet 設定及測試 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow 太平洋時程表中的 hello 對等項目的使用者是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者和太平洋時程表中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

在太平洋時程表中，將指派的 hello hello 值**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入與太平洋時程表，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者太平洋時程表](#creating-a-pacific-timesheet-test-user)** -toohave 許 Simon 太平洋時程表是連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您啟用 Azure AD 單一登入 hello Azure 入口網站中，並在太平洋時程表應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與太平洋時程表中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello**太平洋時程表**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello**太平洋時程表網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-pacific-timesheet-tutorial/tutorial_pacifictimesheet_url.png)

    a. 在 hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<InstanceID>.pacifictimesheet.com/timesheet/home.do`

    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<InstanceID>.pacifictimesheet.com/timesheet/home.do`

    > [!NOTE] 
    > 這些都不是真正的值。 以 hello 實際的識別項和回覆 URL 更新這些值。 請連絡[太平洋時程表支援小組](http://www.pacifictimesheet.com/support)tooget 這些值。
...
6. 在 hello**太平洋時程表組態**區段中，按一下**設定太平洋時程表**tooopen**設定登入**視窗。 複製 hello **SAML 實體識別碼和 SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-pacific-timesheet-tutorial/tutorial_pacifictimesheet_configure.png) 

7. tooconfigure 單一登入上**太平洋時程表**端，您需要下載 toosend hello**憑證 (Base64)**， **SAML 單一登入服務 URL**，和**SAML 實體識別碼**太[太平洋時程表支援小組](http://www.pacifictimesheet.com/support)。 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
在本節中，您要在 Pacific Timesheet 中建立名為 Britta Simon 的使用者。 使用[太平洋時程表支援小組](http://www.pacifictimesheet.com/support)toocreate hello 應用程式中的使用者。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooPacific 時程表啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooPacific 時程表中，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**太平洋時程表**。
...
當您按一下 hello 太平洋時程表並排顯示 hello 存取面板中的時，您應該取得自動登入 tooyour 太平洋時程表應用程式。
