...
在此教學課程中，您學會如何 toointegrate itslearning 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 itslearning 可以提供下列優點 hello:

- 您可以控制存取 tooitslearning Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooitslearning （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure itslearning 與 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 啟用 itslearning 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 itslearning
2. 設定並測試 Azure AD 單一登入

## <a name="adding-itslearning-from-hello-gallery"></a>從 hello 圖庫加入 itslearning
tooconfigure hello 整合 itslearning 到 Azure AD，您需要 tooadd itslearning hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd itslearning 從 hello 組件庫中，執行下列步驟的 hello:**
...
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 itslearning 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 itslearning 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello itslearning 中相關的使用者之間的連結關聯性需要 toobe 建立。

Itslearning 中, 指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 itslearning 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 itslearning](#creating-an-itslearning-test-user)**  -toohave 是連結的 toohello Azure AD 使用者表示法的 itslearning 的許 Simon 的對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 itslearning 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 itslearning，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **itslearning**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **itslearning 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_url.png)

    a. 在 hello**登入 URL**文字方塊中，輸入與 URL:
    | |
    |--| 
    | `https://www.itslearning.com/index.aspx`|
    | `https://us1.itslearning.com/index.aspx`|

    b. 在 hello**識別碼**文字方塊中，輸入 URL:`urn:mace:saml2v2.no:services:com.itslearning`
...
6. tooconfigure 單一登入上**itslearning**端，您需要下載 toosend hello**中繼資料 XML**太[itslearning 支援小組](mailto:support@itslearning.com)。 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
在本節中，您要在 itslearning 中建立名為 Britta Simon 的使用者。 使用[itslearning 用戶端支援小組](mailto:support@itslearning.com)hello itslearning 平台中新增 hello 使用者。 您必須先建立和啟動使用者，然後才能使用單一登入。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooitslearning 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooitslearning，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**itslearning**。
...
當您按一下 hello itslearning 磚 hello 存取面板中的時，您應該取得 itslearning 應用程式的登入頁面。 按一下**登入 Windows Azure ACS1** hello 應用程式的成功登入。
