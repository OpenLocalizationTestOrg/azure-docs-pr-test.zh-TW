...
在此教學課程中，您學會如何 toointegrate Zscaler 與 Azure Active Directory (Azure AD)。

整合 Azure AD 與 Zscaler 可以提供下列優點 hello:

- 您可以控制存取 tooZscaler Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooZscaler （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 Zscaler 的整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 Zscaler
2. 設定並測試 Azure AD 單一登入

## <a name="adding-zscaler-from-hello-gallery"></a>從 hello 圖庫加入 Zscaler
tooconfigure hello 整合 Zscaler 到 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd Zscaler。

**tooadd Zscaler hello 圖庫中，從執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow Zscaler 中的 hello 對等項目的使用者是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 Zscaler 中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

在 Zscaler 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 Zscaler，您必須遵循的建置組塊 toocomplete hello:
...
4. **[建立測試使用者 Zscaler](#creating-a-zscaler-test-user) ** -toohave 許 Simon 是連結的 toohello Azure AD 使用者表示法的 Zscaler 中對應項目。
...
在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Zscaler 的應用程式中。

**tooconfigure Azure AD 單一登入 Zscaler 中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Zscaler**應用程式整合頁面上，按一下 [**單一登入**。
...
3. 在 [hello **Zscaler 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_url.png)

    在 [hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<companyname>.zsclaer.net`

    > [!NOTE] 
    > 這不是真實的值。 更新此值以 hello 實際的登入 URL。 請連絡[Zscaler 用戶端支援小組](https://www.zscaler.com/company/contact)tooget 此值。 
...
6. 在 [hello **Zscaler 組態**區段中，按一下**設定 Zscaler** tooopen**設定登入**視窗。 複製 hello **SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_configure.png) 

7. 在不同的網頁瀏覽器視窗中，系統管理員身分登入 tooyour ZScaler 公司網站。

8. 在 [hello 最上層顯示 hello 功能表上，按一下**管理**。
   
    ![管理](./media/active-directory-saas-zscaler-tutorial/ic800206.png "管理")

9. 在 [管理系統管理員和角色] 下按一下 [管理使用者和驗證]。   
            
    ![管理使用者和驗證](./media/active-directory-saas-zscaler-tutorial/ic800207.png "管理使用者和驗證")

10. 在 [hello**選擇驗證選項，為您的組織**區段中，執行下列步驟的 hello:   
                
    ![驗證](./media/active-directory-saas-zscaler-tutorial/ic800208.png "驗證")
...
11. 在 [hello**設定 SAML 單一登入參數**對話方塊頁面上，執行下列步驟，hello，然後按一下 [**完成**
    ...
    ![單一登入](./media/active-directory-saas-zscaler-tutorial/ic800209.png "單一登入")
...
12. 在 [hello**設定使用者驗證**對話方塊頁面上，執行下列步驟的 hello:
    ...
    ![管理](./media/active-directory-saas-zscaler-tutorial/ic800210.png "管理")
...
5. 在 hello Proxy 伺服器區段中，執行下列步驟的 hello:   
    ...
    b. 在 [hello 位址] 文字方塊中輸入**gateway.zscaler.net**。
...
tooenable Azure AD 使用者 toolog 中 tooZScaler，它們必須已佈建的 tooZScaler。  
在 ZScaler 的 hello 案例中，佈建須手動進行。
...
3. 按一下 [使用者管理] 。   
     ...
     ![新增](./media/active-directory-saas-zscaler-tutorial/ic781036.png "新增")
...
> [!NOTE]
> 您可以使用任何其他 ZScaler 使用者帳戶建立工具或 Api 提供 ZScaler tooprovision AAD 使用者帳戶。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooZscaler 啟用許 Simon toouse Azure 單一登入。
...
當您按一下 hello Zscaler 磚 hello 存取面板中的時，您應該取得 tooyour 自動登入 Zscaler 的應用程式。
