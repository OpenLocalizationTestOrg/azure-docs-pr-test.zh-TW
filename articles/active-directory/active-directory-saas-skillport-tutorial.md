...
在此教學課程中，您學會如何 toointegrate Skillport 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Skillport 可以提供下列優點 hello:

- 您可以控制存取 tooSkillport Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooSkillport （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Skillport 與 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Skillport 單一登入功能的訂用帳戶
...
1. 從 hello 圖庫加入 Skillport
2. 設定並測試 Azure AD 單一登入

## <a name="adding-skillport-from-hello-gallery"></a>從 hello 圖庫加入 Skillport
tooconfigure hello 整合 Skillport 到 Azure AD，您需要 tooadd Skillport hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Skillport 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Skillport**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-skillport-tutorial/tutorial_skillport_search.png)

5. 在 hello 結果 窗格中，選取  **Skillport**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-skillport-tutorial/tutorial_skillport_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 Skillport 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 Skillport 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Skillport 中相關的使用者之間的連結關聯性需要 toobe 建立。

此連結關聯性建立 hello 將值指派為 hello**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** Skillport 中。

tooconfigure 及 Skillport 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Skillport](#creating-a-skillport-test-user)**  -toohave 許 Simon Skillport 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 Skillport 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 Skillport，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Skillport**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Skillport 網域和 Url**區段中，執行下列步驟的 hello:
    ...
    > [!NOTE] 
    > 這些值不是真正的 hello。 Hello 實際的回覆 URL 和登入 URL 更新這些值。 請連絡[Skillport 用戶端支援小組](https://www.skillsoft.com/contact.asp)tooget 這些值。
...
6. tooconfigure 單一登入上**Skillport**端，您需要下載 toosend hello**中繼資料 XML**太[Skillport 支援小組](https://www.skillsoft.com/contact.asp)。 它們會設定它 toohave hello SAML SSO 連線兩端上正確設定。
...
### <a name="creating-a-skillport-test-user"></a>建立 Skillport 測試使用者

在訂單 toocreate Skillport 測試使用者，您需要 toocontact [Skillport 支援小組](https://www.skillsoft.com/contact.asp)因為它們已根據終端使用者 toohello 需求的多個商務案例。 它們將會討論與 hello 使用者之後進行設定。  

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooSkillport 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooSkillport，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Skillport**。
...
當您按一下 hello Skillport 磚 hello 存取面板中的時，您應該取得自動登入 tooyour Skillport 應用程式。
