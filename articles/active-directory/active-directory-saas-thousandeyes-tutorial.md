...
在此教學課程中，您學會如何 toointegrate ThousandEyes 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 ThousandEyes 可以提供下列優點 hello:

- 您可以控制存取 tooThousandEyes Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooThousandEyes （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 ThousandEyes 的整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 ThousandEyes
2. 設定並測試 Azure AD 單一登入

## <a name="adding-thousandeyes-from-hello-gallery"></a>從 hello 圖庫加入 ThousandEyes
tooconfigure hello 整合 ThousandEyes 到 Azure AD，您需要 tooadd ThousandEyes hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd ThousandEyes 從 hello 組件庫中，執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 ThousandEyes 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello ThousandEyes 中相關的使用者之間的連結關聯性需要 toobe 建立。

在 ThousandEyes 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 ThousandEyes，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 ThousandEyes](#creating-a-thousandeyes-test-user)**  -toohave 許 Simon ThousandEyes 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 ThousandEyes 應用程式中。

**tooconfigure Azure AD 單一登入 ThousandEyes 中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **ThousandEyes**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **ThousandEyes 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_url.png)

    在 hello**登入 URL**文字方塊中，輸入與 URL:`https://app.thousandeyes.com/login/sso`
...
6. 在 hello **ThousandEyes 組態**區段中，按一下**設定 ThousandEyes** tooopen**設定登入**視窗。 複製 hello**登出 URL、 SAML 實體識別碼、 和 SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_configure.png) 

7. 在不同的網頁瀏覽器視窗中，登入 tooyour **ThousandEyes**系統管理員身分的公司網站。

8. 在 hello 最上層顯示 hello 功能表上，按一下**設定**。
...
在訂單 tooenable Azure AD 使用者 toolog 到 ThousandEyes，它們必須佈建到 ThousandEyes。  
在 ThousandEyes 的 hello 案例中，佈建須手動進行。

>[!NOTE]
>您可以使用任何其他 ThousandEyes 使用者帳戶建立工具或 Api 提供 ThousandEyes tooprovision Azure Active Directory 使用者帳戶。

**tooprovision 使用者帳戶 tooThousandEyes，執行下列步驟的 hello:**
...
4. 按一下 hello**帳戶和使用者** 索引標籤。
   
    ![帳戶和使用者](./media/active-directory-saas-thousandeyes-tutorial/IC790073.png "帳戶和使用者")

5. 在 hello**新增使用者及帳戶**區段中，執行下列步驟的 hello:
   
    ![新增使用者帳戶](./media/active-directory-saas-thousandeyes-tutorial/IC790074.png "新增使用者帳戶")   
  
    a. 在**名稱**文字方塊中，像是使用者的型別 hello 名稱**許 Simon**。

    b. 在**電子郵件**文字方塊中，型別 hello 電子郵件的使用者喜歡 **brittasimon@contoso.com** 。
   
    b. 按一下**新增使用者 tooAccount**。
      
     >[!NOTE]
     >將會收到電子郵件，包括連結 tooconfirm hello Azure Active Directory 帳戶持有者，並將它啟用 hello 帳戶。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooThousandEyes 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooThousandEyes，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**ThousandEyes**。
...
當您按一下的 hello ThousandEyes 磚 hello 存取面板中時，您應該取得自動登入 tooyour ThousandEyes 的應用程式。
