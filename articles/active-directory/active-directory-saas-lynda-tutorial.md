...
在此教學課程中，您學會如何 toointegrate Lynda.com 與 Azure Active Directory (Azure AD)。

整合 Azure AD 與 Lynda.com 可以提供下列優點 hello:

- 您可以控制存取 tooLynda.com Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooLynda.com （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 Lynda.com 的整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 Lynda.com
2. 設定並測試 Azure AD 單一登入

## <a name="adding-lyndacom-from-hello-gallery"></a>從 hello 圖庫加入 Lynda.com
tooconfigure hello 整合 Lynda.com 的 Azure AD，您需要 tooadd Lynda.com hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd Lynda.com 從 hello 組件庫中，執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 Lynda.com 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello Lynda.com 中相關的使用者之間的連結關聯性需要 toobe 建立。

此連結關聯性建立 hello 將值指派為 hello**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** Lynda.com 中。

tooconfigure 及 Azure AD 單一登入與 Lynda.com 的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Lynda.com](#creating-a-lyndacom-test-user)**  -toohave 許 Simon Lynda.com 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Lynda.com 的應用程式中。

**tooconfigure Azure AD 單一登入與 Lynda.com，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Lynda.com**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Lynda.com 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_url.png)

    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<subdomain>.lynda.com/Shibboleth.sso/InCommon?providerId=<url>&target=<url> `

    > [!NOTE] 
    > 這不是真實的值。 更新此值以 hello 實際的登入 URL。 請連絡[Lynda.com 用戶端支援小組](https://www.linkedin.com/help/lynda/ask)tooget 這些值。 
...
6. tooconfigure 單一登入上**Lynda.com**端，您需要下載 toosend hello**中繼資料 XML** [Lynda.com 支援](https://www.linkedin.com/help/lynda/ask)。
...
不沒有您 tooconfigure 使用者佈建 tooLynda.com 任何動作項目。  
當指派的使用者嘗試 toolog tooLynda.com 使用 hello 存取面板中的時，Lynda.com 會檢查 hello 使用者是否存在。  

如果尚無可用的使用者帳戶，Lynda.com 會自動予以建立。

>[!NOTE]
>您可以使用任何其他 Lynda.com 使用者帳戶建立工具或 Api 提供 Lynda.com tooprovision AAD 使用者帳戶。 

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooLynda.com 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooLynda.com，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Lynda.com**。
