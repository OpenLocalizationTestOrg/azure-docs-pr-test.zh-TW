...
在此教學課程中，您學會如何 toointegrate Kintone 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Kintone 可以提供下列優點的 hello:

- 您可以控制存取 tooKintone Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooKintone （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與 Kintone 的 Azure AD 整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 Kintone
2. 設定並測試 Azure AD 單一登入

## <a name="adding-kintone-from-hello-gallery"></a>從 hello 圖庫加入 Kintone
tooconfigure hello 整合 Kintone 的 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd Kintone。

**tooadd Kintone 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Kintone**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_search.png)

5. 在 hello 結果 窗格中，選取  **Kintone**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 Kintone 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 Kintone 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 Kintone 中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

在 Kintone 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 Kintone，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Kintone](#creating-a-kintone-test-user)**  -toohave 許 Simon Kintone 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Kintone 的應用程式中。

**tooconfigure Azure AD 單一登入 Kintone 中，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Kintone**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Kintone 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_url.png)

    a. 在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<companyname>.kintone.com`
    ...
    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello 登入 URL 和識別項。 請連絡[Kintone 用戶端支援小組](https://www.kintone.com/contact/)tooget 這些值。 
...
6. 在 hello **Kintone 組態**區段中，按一下**設定 Kintone** tooopen**設定登入**視窗。 複製 hello**登出 URL 和 SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_configure.png) 

7. 在不同的 Web 瀏覽器視窗中，以系統管理員身分登入您的 **Kintone** 公司網站。
...
12. 在 hello SAML 驗證 區段中，執行下列步驟的 hello:
    ...
    a. 在 hello**登入 URL**文字方塊中，貼上 hello 值**SAML 單一登入服務 URL**您從 Azure 入口網站複製的。
   
    b. 在 hello**登出 URL**文字方塊中，貼上 hello 值**登出 URL**您從 Azure 入口網站複製的。
    
    c. 按一下**瀏覽**tooupload 下載的憑證。
...
### <a name="creating-a-kintone-test-user"></a>建立 Kintone 測試使用者

tooenable Azure AD 使用者 toolog 中 tooKintone，它們必須佈建到 Kintone。  
在 Kintone 的 hello 案例中，佈建須手動進行。

### <a name="tooprovision-a-user-account-perform-hello-following-steps"></a>tooprovision 使用者帳戶，執行下列步驟的 hello:

1. 登入 tooyour **Kintone**系統管理員身分的公司網站。
...
5. 按一下 [新使用者] 。
    ...
    ![新使用者](./media/active-directory-saas-kintone-tutorial/ic785889.png "新使用者")

6. 在 hello**新使用者**區段中，執行下列步驟的 hello:
   
    ![新使用者](./media/active-directory-saas-kintone-tutorial/ic785890.png "新使用者")
   
    a. 輸入**顯示名稱**，**登入名稱**，**新密碼**，**確認密碼**，**電子郵件地址**，和您想 tooprovision 寫入 hello 的有效 AAD 帳戶的其他詳細資料相關的文字方塊。
 
    b. 按一下 [儲存] 。

> [!NOTE]
> 您可以使用任何其他 Kintone 使用者帳戶建立工具或 Api 提供 Kintone tooprovision AAD 使用者帳戶。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooKintone 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooKintone，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Kintone**。
...
當您按一下 hello Kintone 磚 hello 存取面板中的時，您應該取得自動登入 tooyour Kintone 的應用程式。
