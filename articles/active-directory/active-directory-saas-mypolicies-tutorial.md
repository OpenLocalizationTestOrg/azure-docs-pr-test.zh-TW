...
在此教學課程中，您學會如何 toointegrate myPolicies 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 myPolicies 可以提供下列優點 hello:

- 您可以控制存取 toomyPolicies Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 toomyPolicies （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure myPolicies 與 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 啟用 myPolicies 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 myPolicies
2. 設定並測試 Azure AD 單一登入

## <a name="adding-mypolicies-from-hello-gallery"></a>從 hello 圖庫加入 myPolicies
tooconfigure hello 整合 myPolicies 到 Azure AD，您需要 tooadd myPolicies hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd myPolicies 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**myPolicies**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-mypolicies-tutorial/tutorial_mypolicies_search.png)

5. 在 hello 結果 窗格中，選取  **myPolicies**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-mypolicies-tutorial/tutorial_mypolicies_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 myPolicies 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 myPolicies 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello myPolicies 中相關的使用者之間的連結關聯性需要 toobe 建立。

MyPolicies 中, 指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 myPolicies 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 myPolicies](#creating-a-mypolicies-test-user)**  -toohave 是連結的 toohello Azure AD 使用者表示法的 myPolicies 的許 Simon 的對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 myPolicies 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 myPolicies，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **myPolicies**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **myPolicies 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-mypolicies-tutorial/tutorial_mypolicies_url.png)

    a. 在 hello**識別碼**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenantname>.mypolicies.com/`

    b. 在 hello**回覆 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<tenantname>.mypolicies.com/users/auth/saml/callback`

    > [!NOTE] 
    > 這些都不是真正的值。 以 hello 實際的識別項和回覆 URL 更新這些值。 請連絡[myPolicies 支援小組](mailto:support@mypolicies.com)tooget 這些值。

4. hello myPolicies 應用程式預期 hello SAML 判斷提示，以特定格式，這需要您 tooadd 自訂屬性對應 tooyour SAML token 屬性設定。 設定下列宣告為此應用程式的 hello。 您可以從 hello 管理 hello 這些屬性的值"**使用者屬性**」 一節，在應用程式整合頁面上。 hello 下列螢幕擷取畫面會顯示這個範例。 
...
5. 按一下**檢視和編輯所有其他使用者屬性**核取方塊在 hello**使用者屬性**區段 tooexpand hello 屬性。 執行下列步驟，在每個顯示 hello 屬性-hello
    ...
    a. 按一下 hello 屬性 tooopen hello**編輯屬性**對話方塊。
...
6. 在 hello **SAML 簽章憑證**區段中，按一下**Certificate(Base64)**然後儲存您的電腦上的 hello 憑證檔案。
...
8. 在 hello **myPolicies 組態**區段中，按一下**設定 myPolicies** tooopen**設定登入**視窗。 複製 hello **SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-mypolicies-tutorial/tutorial_mypolicies_configure.png) 

9. tooconfigure 單一登入上**myPolicies**端，您需要下載 toosend hello **Certificate(Base64)**和**SAML 單一登入服務 URL**太[myPolicies 支援小組](mailto:support@mypolicies.com)。 
...
在本節中，您要在 myPolicies 中建立名為 Britta Simon 的使用者。 使用[myPolicies 支援小組](mailto:support@mypolicies.com)hello myPolicies 平台中新增 hello 使用者。 您必須先建立和啟動使用者，然後才能使用單一登入。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 toomyPolicies 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon toomyPolicies，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**myPolicies**。
...
當您按一下的 hello myPolicies 磚 hello 存取面板中時，您應該取得自動登入 tooyour myPolicies 應用程式。
