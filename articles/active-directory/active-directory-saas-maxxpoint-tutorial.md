...
在此教學課程中，您學會如何 toointegrate MaxxPoint 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 MaxxPoint 可以提供下列優點 hello:

- 您可以控制存取 tooMaxxPoint Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooMaxxPoint （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure MaxxPoint 與 Azure AD 整合，您需要下列項目 hello:
...
1. 從 hello 圖庫加入 MaxxPoint
2. 設定並測試 Azure AD 單一登入


## <a name="adding-maxxpoint-from-hello-gallery"></a>從 hello 圖庫加入 MaxxPoint
tooconfigure hello 整合 MaxxPoint 到 Azure AD，您需要 tooadd MaxxPoint hello 圖庫 tooyour 清單中的受管理的 SaaS 應用程式。

**tooadd MaxxPoint 從 hello 組件庫中，執行下列步驟的 hello:**
...
3. 按一下**新的應用程式**上 hello 對話方塊 tooadd 新應用程式頂端的按鈕。

    ![應用程式][3]

4. 在 [hello] 搜尋方塊中，輸入**MaxxPoint**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_001.png)

5. 在 hello 結果 窗格中，選取  **MaxxPoint**，然後按一下**新增**按鈕 tooadd hello 應用程式。
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 MaxxPoint 是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello MaxxPoint 中相關的使用者之間的連結關聯性需要 toobe 建立。

此連結關聯性建立 hello 將值指派為 hello**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** MaxxPoint 中。

tooconfigure 及 MaxxPoint 與 Azure AD 單一登入的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 MaxxPoint](#creating-a-maxxpoint-test-user)**  -toohave 許 Simon 是連結的 toohello Azure AD 表示她的 MaxxPoint 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 MaxxPoint 應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 MaxxPoint，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **MaxxPoint**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **MaxxPoint 網域和 Url**區段中，如果您想 tooconfigure hello 應用程式中的**IDP 初始化模式**，而不需要 tooperform 任何步驟。

    ![設定單一登入](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_02.png)
    
4. 在 hello **MaxxPoint 網域和 Url**區段中，如果您想 tooconfigure hello 應用程式中的**SP 初始模式**，執行下列步驟的 hello:
    
    ![設定單一登入](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_03.png)

    a. 按一下 [顯示進階 URL 設定] 選項。

    b. 在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`

    > [!NOTE] 
    > 請注意，這不是 hello 真正的價值。 您有的 tooupdate 這個值與實際的 hello 登入 URL。 在上呼叫 MaxxPoint 小組**888-728-0950** tooget 此值。
...
7. tooget SSO 設定您的應用程式上, 呼叫 MaxxPoint 支援小組**888-728-0950** ，它們會協助您進一步上如何下載它們 hello 的 tooprovide**中繼資料 XML**檔案。 
...
在本節中，您要在 MaxxPoint 中建立名為 Britta Simon 的使用者。 請在呼叫 MaxxPoint 支援小組**888-728-0950** tooadd hello hello MaxxPoint 應用程式的使用者。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與他們存取 tooMaxxPoint 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooMaxxPoint，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**MaxxPoint**。
...
當您按一下 hello MaxxPoint 磚 hello 存取面板中的時，您應該取得自動登入 tooyour MaxxPoint 應用程式。
