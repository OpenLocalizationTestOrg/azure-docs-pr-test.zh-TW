...
在此教學課程中，您學會如何 toointegrate TeamSeer 與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 TeamSeer 可以提供下列優點的 hello:

- 您可以控制存取 tooTeamSeer Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooTeamSeer （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與 TeamSeer 的 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 TeamSeer 單一登入的訂用帳戶
...
1. 從 hello 圖庫加入 TeamSeer
2. 設定並測試 Azure AD 單一登入

## <a name="adding-teamseer-from-hello-gallery"></a>從 hello 圖庫加入 TeamSeer
tooconfigure hello 整合 TeamSeer tooAzure AD 中的，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd TeamSeer。

**tooadd TeamSeer 從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**TeamSeer**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-teamseer-tutorial/tutorial_teamseer_search.png)

5. 在 hello 結果 窗格中，選取  **TeamSeer**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-teamseer-tutorial/tutorial_teamseer_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 TeamSeer 搭配運作的 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者在 TeamSeer 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello TeamSeer 中相關的使用者之間的連結關聯性需要 toobe 建立。

在 TeamSeer 中，將指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 TeamSeer，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 TeamSeer](#creating-a-teamseer-test-user)**  -toohave 許 Simon TeamSeer 所連結的 toohello Azure AD 使用者表示法中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 TeamSeer 的應用程式中。

**tooconfigure Azure AD 單一登入 TeamSeer，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **TeamSeer**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **TeamSeer 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-teamseer-tutorial/tutorial_teamseer_url.png)

     在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://www.teamseer.com/<companyid>`

    > [!NOTE] 
    > hello 值不是真正的。 更新 hello 值與 hello 實際的登入 URL。 請連絡[TeamSeer 用戶端支援小組](http://pages.theaccessgroup.com/solutions_business-suite_absence-management_contact.html)tooget hello 值。 
...
6. 在 hello **TeamSeer 組態**區段中，按一下**設定 TeamSeer** tooopen**設定登入**視窗。 複製 hello **SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-teamseer-tutorial/tutorial_teamseer_configure.png)

7. 在不同的網頁瀏覽器視窗中，系統管理員身分登入 tooyour TeamSeer 公司網站。
...
10. 按一下 [設定 SAML 提供者詳細資料] 。
   
    ![SAML 設定](./media/active-directory-saas-teamseer-tutorial/ic789636.png "SAML 設定")

11. 在 hello SAML 提供者詳細資料 區段中，執行下列步驟的 hello:
   
    ![SAML 設定](./media/active-directory-saas-teamseer-tutorial/ic789637.png "SAML 設定")   

    a. 貼上 hello**單一登入服務 URL**中 toohello 值**URL**文字方塊。
          
    b. 在 記事本，複製 hello tooyour 剪貼簿 中，在它的內容中開啟 base-64 編碼的憑證，然後將它貼入 toohello **IdP 公用憑證**文字方塊。

12. toocomplete hello SAML 提供者組態，執行下列步驟的 hello:
    
    ![SAML 設定](./media/active-directory-saas-teamseer-tutorial/ic789638.png "SAML 設定") 

    a. 在 hello**測試電子郵件地址**，輸入 hello 測試使用者的電子郵件地址。 
  
    b. 在 [hello**簽發者**類型 hello hello 服務提供者的簽發者 URL] 文字方塊中。 
...
### <a name="creating-a-teamseer-test-user"></a>建立 TeamSeer 測試使用者

tooenable Azure AD 使用者 toolog 中 tooTeamSeer，必須將他們佈建 tooShiftPlanning 中。 在 TeamSeer 的 hello 案例中，佈建須手動進行。

**tooprovision 使用者帳戶，執行下列步驟的 hello:**

1. 登入 tooyour **TeamSeer**系統管理員身分的公司網站。
...
2. 執行下列步驟的 hello:
    ...
    b. 按一下**執行 hello 新增使用者精靈**。

3. 在 hello**使用者詳細資料**區段中，執行下列步驟的 hello:
   
    ![使用者詳細資料](./media/active-directory-saas-teamseer-tutorial/ic789641.png "使用者詳細資料")

    a. 型別 hello**名字**，**姓氏**，**使用者名稱 （電子郵件地址）**的有效 AAD 帳戶，您想要在 toohello tooprovision 相關的文字方塊。
  
    b. 按一下 [下一步] 。

4. 依照 hello 螢幕上指示，加入新的使用者，並按一下**完成**。

>[!NOTE]
>您可以使用任何其他 TeamSeer 使用者帳戶建立工具或 Api 提供 TeamSeer tooprovision Azure AD 使用者帳戶。 

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooTeamSeer 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooTeamSeer，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**TeamSeer**。
