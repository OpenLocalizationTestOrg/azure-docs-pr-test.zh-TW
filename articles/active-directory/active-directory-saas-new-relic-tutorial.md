...
在此教學課程中，您學會如何 toointegrate New Relic 與 Azure Active Directory (Azure AD)。

New Relic 整合與 Azure AD 可以提供下列優點 hello:

- 您可以控制存取 tooNew Relic 的 Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooNew Relic （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure 與 New Relic 的 Azure AD 整合，您需要下列項目 hello:
...
1. New Relic 加入從 hello 組件庫
2. 設定並測試 Azure AD 單一登入

## <a name="adding-new-relic-from-hello-gallery"></a>New Relic 加入從 hello 組件庫
tooconfigure hello 整合 New Relic 的 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd New Relic。

**tooadd New Relic 從 hello 組件庫中，執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者 New Relic 中是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello New Relic 中相關的使用者之間的連結關聯性需要 toobe 建立。

在 New Relic 中，將指派的 hello hello 值**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 New Relic，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立 New Relic 測試使用者](#creating-a-new-relic-test-user)** -toohave 許 Simon 是連結的 toohello Azure AD 使用者表示法的 New Relic 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 New Relic 應用程式中。

**tooconfigure Azure AD 單一登入 New Relic，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **New Relic**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello**新 Relic 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_url.png)

    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://<subdomain>.newrelic.com`

    > [!NOTE] 
    > hello 值不是真正的。 更新 hello 值與 hello 實際的登入 URL。 請連絡[新 Relic 用戶端支援小組](https://support.newrelic.com/)tooget hello 值。 
...
6. 在 hello**新 Relic 組態**區段中，按一下**設定 New Relic** tooopen**設定登入**視窗。 複製 hello**登出 URL 和 SAML 單一登入服務 URL**從 hello**快速參考 > 一節。**

    ![設定單一登入](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_configure.png) 

7. 在不同的網頁瀏覽器視窗中，登入 tooyour **New Relic**以系統管理員身分的公司網站。

8. 在 hello 最上層顯示 hello 功能表上，按一下**帳戶設定**。
   
    ![帳戶設定](./media/active-directory-saas-new-relic-tutorial/ic797036.png "帳戶設定")

9. 按一下 hello**安全性和驗證**索引標籤，然後再按一下 [hello**單一登入**] 索引標籤。
...
10. 在 hello SAML 對話方塊頁面上，執行下列步驟的 hello:
   ...
   a. 按一下**選擇檔案**tooupload 下載的 Azure Active Directory 憑證。

   b. 在 hello**遠端登入 URL**文字方塊中，貼上 hello 值**SAML 單一登入服務 URL**，從 Azure 入口網站複製的。
   
   c. 在 hello**登出登陸 URL**文字方塊中，貼上 hello 值**登出 URL**，從 Azure 入口網站複製的。
...
### <a name="creating-a-new-relic-test-user"></a>建立 New Relic 測試使用者

在訂單 tooenable Azure Active Directory 使用者 toolog tooNew Relic 中，您必須是佈建到 New Relic。 中的 New Relic hello 案例中，佈建須手動進行。

**tooprovision 使用者帳戶 tooNew Relic，執行下列步驟的 hello:**

1. 登入 tooyour **New Relic**以系統管理員身分的公司網站。

2. 在 hello 最上層顯示 hello 功能表上，按一下**帳戶設定**。
   
    ![帳戶設定](./media/active-directory-saas-new-relic-tutorial/ic797040.png "帳戶設定")

3. 在 hello**帳戶**hello 窗格的左側，按一下**摘要**，然後按一下**新增使用者**。
   
    ![帳戶設定](./media/active-directory-saas-new-relic-tutorial/ic797041.png "帳戶設定")

4. 在 [hello**作用中使用者**] 對話方塊中，執行下列步驟的 hello:
   
    ![作用中使用者](./media/active-directory-saas-new-relic-tutorial/ic797042.png "作用中使用者")
   
    a. 在 hello**電子郵件**文字方塊中，型別 hello 電子郵件地址的有效的 Azure Active Directory 使用者，您想要 tooprovision。
...
>[!NOTE]
>您可以使用任何其他 New Relic 使用者帳戶建立工具或 Api 提供 New Relic tooprovision AAD 使用者帳戶。
> 

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooNew Relic 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooNew Relic，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**New Relic**。
...
當您按一下 hello New Relic 磚 hello 存取面板中的時，您應該取得 tooyour 自動登入 New Relic 的應用程式。
