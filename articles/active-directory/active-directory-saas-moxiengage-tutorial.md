...
在此教學課程中，您學會如何 toointegrate Moxi 洽詢 Azure Active Directory (Azure AD)。

Azure AD 整合 Moxi 連絡提供您 hello 下列優點：

- 您可以控制存取 tooMoxi Engage Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooMoxi Engage （單一登入） 具有其 Azure AD 帳戶
...
tooconfigure Azure AD 與 Moxi 進行整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 啟用 Moxi Engage 單一登入的訂用帳戶
...
1. 從 hello 組件庫中加入 Moxi 連絡
2. 設定並測試 Azure AD 單一登入

## <a name="adding-moxi-engage-from-hello-gallery"></a>從 hello 組件庫中加入 Moxi 連絡
tooconfigure hello 整合 Moxi 連絡到 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd Moxi 連絡。

**tooadd Moxi 連絡從 hello 組件庫中，執行下列步驟的 hello:**
...
4. 在 [hello] 搜尋方塊中，輸入**Moxi 連絡**。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxiengage-tutorial/tutorial_moxiengage_search.png)

5. 在 hello 結果 窗格中，選取  **Moxi 連絡**，然後按一下**新增**按鈕 tooadd hello 應用程式。

    ![建立 Azure AD 測試使用者](./media/active-directory-saas-moxiengage-tutorial/tutorial_moxiengage_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>設定並測試 Azure AD 單一登入
在本節中，您會以名為 "Britta Simon" 的測試使用者身分，使用 Moxi Engage 設定及測試 Azure AD 單一登入。

單一登入 toowork，Azure AD 需要 tooknow hello 的對等項目的使用者中 Moxi 連絡是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 hello 中 Moxi 連絡相關的使用者之間的連結關聯性需要 toobe 建立。

在 Moxi 要交流，將指派的 hello hello 值**使用者名稱**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及 Azure AD 單一登入具有 Moxi 中進行的測試，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Moxi 連絡](#creating-a-moxi-engage-test-user)** -toohave 許 Simon 中 Moxi 連絡連結的 toohello Azure AD 使用者表示法的對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並 Moxi 連絡應用程式中設定單一登入。

**tooconfigure Azure AD 單一登入與 Moxi 要交流，執行下列步驟的 hello:**

1. 在 Azure 入口網站上 hello hello **Moxi 連絡**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Moxi 連絡的網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-moxiengage-tutorial/tutorial_moxiengage_url.png)

    在 hello**登入 URL**文字方塊中，輸入 URL，使用下列模式的 hello:`https://svc.<moxiworks-integration-domain>/service/v1/auth/inbound/saml/aad`

    > [!NOTE] 
    > 這不是真實的值。 更新此值以 hello 實際的登入 URL。 請連絡[Moxi 連絡用戶端支援小組](mailto:support@moxiworks.com)tooget 此值。 
...
6. tooconfigure 單一登入上**Moxi 連絡**端，您需要下載 toosend hello**中繼資料 XML**太[Moxi 連絡支援小組](mailto:support@moxiworks.com)。 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
### <a name="creating-a-moxi-engage-test-user"></a>建立 Moxi Engage 測試使用者

在本節中，您要在 Moxi Engage 中建立名為 Britta Simon 的使用者。 使用[Moxi 連絡支援小組](mailto:support@moxiworks.com)hello Moxi 連絡平台中新增 hello 使用者。

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooMoxi Engage 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooMoxi Engage，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Moxi 連絡**。
...
當您按一下 hello Moxi 連絡並排顯示 hello 存取面板中的時，您應該取得自動登入 tooMoxi 進行應用程式。
