...
在此教學課程中，您學會如何 toointegrate Learningpool 做與 Azure Active Directory (Azure AD)。

與 Azure AD 整合 Learningpool Act 可以提供下列優點 hello:

- 您可以控制存取 tooLearningpool Act Azure AD 中
- 您可以啟用您的使用者 tooautomatically get 登入 tooLearningpool （單一登入） 的動作使用其 Azure AD 帳戶
...
tooconfigure 與 Learningpool Act 的 Azure AD 整合，您需要下列項目 hello:

- Azure AD 訂用帳戶
- 已啟用 Learningpool Act 單一登入的訂用帳戶
...
1. 加入 Learningpool Act 從 hello 組件庫
2. 設定並測試 Azure AD 單一登入

## <a name="adding-learningpool-act-from-hello-gallery"></a>加入 Learningpool Act 從 hello 組件庫
tooconfigure hello 整合 Learningpool Act 到 Azure AD，您需要從受管理的 SaaS 應用程式的 hello 圖庫 tooyour 清單 tooadd Learningpool 動作。

**tooadd Learningpool Act 從 hello 組件庫中，執行下列步驟的 hello:**
...
單一登入 toowork，Azure AD 需要 tooknow Learningpool Act 中的 hello 對等項目的使用者是 tooa 使用者在 Azure AD 中。 換句話說，Azure AD 使用者與 Learningpool Act 中的 hello 相關的使用者之間的連結關聯性需要 toobe 建立。

Learningpool act 中指派的 hello hello 值**使用者名**做為 hello hello 值的 Azure AD 中**Username** tooestablish hello 連結關聯性。

tooconfigure 及測試 Azure AD 單一登入 Learningpool 動作，您必須遵循的建置組塊 toocomplete hello:

1. **[設定 Azure AD 單一登入](#configuring-azure-ad-single-sign-on)** -tooenable 使用者 toouse 這項功能。
2. **[建立 Azure AD 測試使用者](#creating-an-azure-ad-test-user)** -tootest Azure AD 單一登入與許 Simon。
3. **[建立測試使用者 Learningpool Act](#creating-a-learningpool-act-test-user)**  -toohave 許 Simon 是連結的 toohello Azure AD 使用者表示法的 Learningpool Act 中對應項目。
4. **[指派 hello Azure AD 的測試使用者](#assigning-the-azure-ad-test-user)** -tooenable 許 Simon toouse Azure AD 單一登入。
5. **[測試單一登入](#testing-single-sign-on)** -tooverify 是否 hello 組態工作。

### <a name="configuring-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您可以啟用 Azure AD 單一登入 hello Azure 入口網站中，並設定單一登入 Learningpool Act 應用程式中。

**tooconfigure Azure AD 單一登入 Learningpool 作用中、 與執行 hello 下列步驟：**

1. 在 Azure 入口網站上 hello hello **Learningpool Act**應用程式整合頁面上，按一下 **單一登入**。
...
3. 在 hello **Learningpool Act 網域和 Url**區段中，執行下列步驟的 hello:

    ![設定單一登入](./media/active-directory-saas-Learningpool-tutorial/tutorial_Learningpoolact_url.png)

    a. 在 hello**登入 URL**文字方塊中，型別 hello URL:`https://parliament.preview.Learningpool.com/auth/shibboleth/index.php`
    ...
    > [!NOTE] 
    > 這些都不是真正的值。 更新這些值與實際的 hello 登入 URL 和識別項。 請連絡[Learningpool Act 用戶端支援小組](https://www.Learningpool.com/support)tooget 這些值。 
...
5. Learningpool Act 應用程式預期 hello SAML 判斷提示，以特定格式。 請設定下列宣告為此應用程式的 hello。 您可以從 hello 管理這些屬性的 hello 值**」 屬性 「** hello 應用程式 索引標籤。 hello 下列螢幕擷取畫面會顯示這個範例。 
...
8. tooconfigure 單一登入上**Learningpool Act**端，您需要下載 toosend hello**中繼資料 XML**太[Learningpool Act 支援小組](https://www.Learningpool.com/support)。 設定此設定 toohave hello SAML SSO 連線兩端上正確設定這些欄位。
...
### <a name="creating-a-learningpool-act-test-user"></a>建立 Learningpool Act 測試使用者

tooenable Azure AD 使用者 toolog 中 tooLearningpool Act，它們必須佈建到 Learningpool 動作。

沒有您 tooconfigure 使用者佈建 tooLearningpool 動作的動作項目。  
使用者需要由 toobe 您[Learningpool Act 支援小組](https://www.Learningpool.com/support)。

>[!NOTE]
>您可以使用任何其他 Learningpool Act 使用者帳戶建立工具或應用程式開發介面由 Learningpool Act tooprovision AAD 使用者帳戶。 

### <a name="assigning-hello-azure-ad-test-user"></a>指派 hello Azure AD 的測試使用者

在本節中，您可以授與存取 tooLearningpool Act 啟用許 Simon toouse Azure 單一登入。

![指派使用者][200] 

**tooassign 許 Simon tooLearningpool 動作，執行下列步驟的 hello:**

1. 在 hello Azure 入口網站，開啟 hello 應用程式檢視，然後導覽 toohello 目錄檢視，並跳過**企業應用程式**然後按一下 **所有應用程式**。

    ![指派使用者][201] 

2. 在 [hello] 應用程式清單中，選取**Learningpool Act**。
...
當您按一下的 hello Learningpool Act 磚 hello 存取面板中時，您應該取得自動登入 tooyour Learningpool Act 應用程式。
