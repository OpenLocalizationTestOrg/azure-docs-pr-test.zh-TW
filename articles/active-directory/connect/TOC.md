...
### [變更 hello 預設組態](active-directory-aadconnectsync-best-practices-changing-default-configuration.md)
...
### [變更 hello Azure AD 同步服務帳戶密碼](active-directory-aadconnectsync-change-serviceacct-pass.md)
### [變更 hello AD DS 帳戶的密碼](active-directory-aadconnectsync-change-addsacct-pass.md)
...
### [如何從 LocalDB 10 GB 的限制 toorecover](active-directory-aadconnect-recover-from-localdb-10gb-limit.md)
...
### [同步處理 tooAzure Active Directory 的屬性](active-directory-aadconnectsync-attributes-synchronized.md)
...
# 相關參考
## [監視您內部部署識別基礎結構和同步處理服務 hello 雲端中](../connect-health/active-directory-aadconnect-health.md)
