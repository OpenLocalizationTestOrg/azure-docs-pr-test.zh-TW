...
本主題說明如何產生的編碼工作 toocreate 分散 MP4 (fMP4) 區塊，而不是 ISO MP4 檔案。 toogenerate fMP4 區塊，使用 hello**媒體編碼器標準**或**媒體編碼器高階工作流程**編碼工作，以及指定的編碼器 toocreate **AssetFormatOption.AdaptiveStreaming**選項，此程式碼片段所示：  
