...
## [使用 AAD 驗證 tooaccess 應用程式開發介面](media-services-use-aad-auth-to-access-ams-api.md)
### [使用入口網站 toomanage AAD 驗證](media-services-portal-get-started-with-aad.md)
### [使用 .NET 存取 API](media-services-dotnet-get-started-with-aad.md)
### [使用 REST 存取 API](media-services-rest-connect-with-aad.md)
### [使用 CLI toocreate 並設定 AAD 應用程式](media-services-cli-create-and-configure-aad-app.md)
### [使用 PowerShell toocreate 並設定 AAD 應用程式](media-services-powershell-create-and-configure-aad-app.md)
...
#### [使用 MES tooauto-產生的位元速率階梯](media-services-autogen-bitrate-ladder-with-mes.md)
#### 以媒體編碼器標準編碼
...
### [在 hello 入口網站中設定內容保護](media-services-portal-protect-content.md)
### [為串流設定 AES-128 清除金鑰](media-services-protect-with-aes128.md)
### [使用 REST tooencrypt 與儲存體加密內容](media-services-rest-storage-encryption.md)
...
### [使用協力廠商 toodeliver Widevine 授權 tooMedia 服務](media-services-licenses-partner-integration.md)
#### [使用 Axinom toodeliver Widevine 授權 tooMedia Services](media-services-axinom-integration.md)
#### [使用 castLabs toodeliver Widevine 授權 tooMedia Services](media-services-castlabs-integration.md)
...
### [分析使用 hello 入口網站的媒體](media-services-portal-analyze.md)
...
### [Hello 用戶端上插入廣告](media-services-inserting-ads-on-client-side.md)
