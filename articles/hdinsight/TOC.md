...
#### [使用 hello hive 控制檔的檢視](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [使用 hello HDInsight tools for Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [使用遠端桌面](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [使用 hello 查詢主控台](hdinsight-hadoop-use-hive-query-console.md)
...
### [執行 hello MapReduce 範例](hdinsight-hadoop-run-samples-linux.md)
...
#### [使用.NET SDK hello](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [寫入 tooData 湖存放區](hdinsight-storm-write-data-lake-store.md)
...
### [使用 HDInsight Tools toocreate Spark 應用程式](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [使用從遠端透過 SSH 的 HDInsight Tools toodebug Spark 應用程式](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [連接 Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [使用 hello Hive JDBC 驅動程式連接](hdinsight-connect-hive-jdbc-driver.md)
...
### [HDInsight tooyour 在內部部署網路連線](connect-on-premises-network.md)
...
#### [使用 REST tooinstall 應用程式](https://msdn.microsoft.com/library/mt706515.aspx)
#### [發行 HDInsight 應用程式 tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## 安全
### [搭配使用 SSH 與 HDInsight](hdinsight-hadoop-linux-use-ssh-unix.md)
### [使用 SSH 通道](hdinsight-linux-ambari-ssh-tunnel.md)
### [限制存取 toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## 管理
...
#### [使用 cURL 和 hello Azure REST API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [使用.NET SDK hello](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [使用 Azure CLI hello](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [使用 hello Azure 入口網站](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [使用 Azure CLI hello](hdinsight-administer-use-command-line.md)
### [管理叢集使用 hello Ambari web UI](hdinsight-hadoop-manage-ambari.md)
...
### [移轉 tooResource 管理員開發工具](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [可用性與可靠性](hdinsight-high-availability-linux.md)
### [HDInsight 叢集 toonewer 版本升級](hdinsight-upgrade-cluster.md)
...
#### [使用 Ambari 檢視 toodebug Tez 作業](hdinsight-debug-ambari-tez-view.md)
...
# 相關參考
## Windows 叢集
### [移轉 Windows 叢集 tooLinux 叢集](hdinsight-migrate-from-windows-to-linux.md)
### [移轉.NET 方案 tooLinux 叢集](hdinsight-hadoop-migrate-dotnet-to-linux.md)
### [執行 Hadoop MapReduce 範例](hdinsight-run-samples.md)
### [叢集上的 Solr](hdinsight-hadoop-solr-install-linux.md)
### [使用 Giraph tooprocess 大規模圖形](hdinsight-hadoop-giraph-install.md)
### [工作流程使用 Oozie](hdinsight-use-oozie.md)
### [部署和管理 Storm 拓撲](hdinsight-storm-deploy-monitor-topology.md)
### [使用 Maven toobuild Java 應用程式](hdinsight-hbase-build-java-maven.md)
### [使用 hello Tez UI toodebug Tez 工作](hdinsight-debug-tez-ui.md)
...
### [監視叢集使用 hello Ambari 應用程式開發介面](hdinsight-monitor-use-ambari-api.md)

# 資源
## [Azure 藍圖](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [取得 hello 論壇的說明](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
