---
title: "aaaHadoop 堆疊追蹤錯誤訊息-Azure HDInsight |Microsoft 文件"
description: "Azure HDInsight 中 Hadoop 堆疊追蹤錯誤訊息的索引。 尋找 hello 中錯誤 hello 清單 toosee 疑難排解資訊。"
keywords: "堆疊追蹤，錯誤訊息"
services: hdinsight
...
* [修正 HDInsight 中 Hive 記憶體不足錯誤](hdinsight-hadoop-hive-out-of-memory-error-oom.md)：解決 Hive 查詢的記憶體不足錯誤 (OOM)。 hello 客戶案例包括跨多個大型資料表的查詢。

## <a name="hive-query-performance"></a>Hive 查詢效能
* [最佳化 HDInsight 中的 Hadoop Hive 查詢](hdinsight-hadoop-optimize-hive-query.md)： 本文件涵蓋您可以套用 tooHive 查詢一些最常見 Hive 效能最佳化方法。
