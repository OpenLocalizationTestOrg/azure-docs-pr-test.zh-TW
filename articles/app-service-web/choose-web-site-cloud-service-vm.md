...
* 迅速建立一個[行動應用程式](../app-service-mobile/app-service-mobile-value-prop.md)或 [API 應用程式](../app-service-api/app-service-api-apps-why-best-platform.md)，以將 HTTP Web 服務裝載於 Azure 全球各地的其中一個資料中心內。
* 移轉現有的服務或建立新服務。
