...
請注意，您可以使用原始檔控制來上傳應用程式或網頁，包括 [連續整合案例](app-service-continuous-deployment.md)。 FTP 也是上傳您的應用程式或網頁的選項，如需透過 FTP 部署您應用程式的詳細資訊，請參閱 [將應用程式部署至 Azure App Service]。
...
[將應用程式部署至 Azure App Service]: ./web-sites-deploy.md
