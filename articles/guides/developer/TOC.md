...
## [Azure 服務概觀](../../fundamentals-introduction-to-azure.md?toc=%2fazure%2fdeveloper-guide%2ftoc.json)
## [入口網站概觀](../../azure-portal-overview.md?toc=%2fazure%2fdeveloper-guide%2ftoc.json)
...
# 概念
## [帳單及訂用帳戶](../../billing/billing-getting-started.md)
## [主機比較](../../app-service-web/choose-web-site-cloud-service-vm.md)
## [什麼是 App Service？](../../app-service/app-service-value-prop-what-is.md)
## 虛擬機器
...
### [微服務叢集](../../service-fabric/service-fabric-cluster-creation-via-portal.md)
## 部署
### [從原始檔控制 Web 和行動裝置應用程式](../../app-service-web/app-service-continuous-deployment.md)
### [本機微服務](../../service-fabric/service-fabric-get-started-with-a-local-cluster.md)
...
### [虛擬機器](../../virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md)
...
### [虛擬機器](../../backup/backup-azure-vms-introduction.md)
...
## 自動化
### [敏捷式 Web 應用程式部署](../../app-service-web/app-service-agile-software-development.md)
### [調整 Linux VM](../../virtual-machines/virtual-machines-linux-vertical-scaling-automation.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
### [使用 Chef 建立 Windows VM](../../virtual-machines/virtual-machines-windows-chef-automation.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
## [計費](../../billing/billing-usage-rate-card-overview.md)
