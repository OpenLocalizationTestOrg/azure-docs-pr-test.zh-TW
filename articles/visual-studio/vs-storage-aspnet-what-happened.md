...
---
# <a name="what-happened-toomy-aspnet-project-visual-studio-azure-storage-connected-service"></a>哪些情形的 toomy ASP.NET 專案 （Visual Studio Azure 儲存體已連線服務）？
...
在 hello web.config 檔案中的專案，項目已建立具有 hello 選取儲存體帳戶的連接字串和機碼。
