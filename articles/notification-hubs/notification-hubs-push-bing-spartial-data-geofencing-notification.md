...
## <a name="testing-push-notifications-in-the-uwp-app"></a>在 UWP 應用程式中測試推播通知
...
接著，由於您要確保會對正確的參與者進行傳遞，因此您可以透過 [標記](notification-hubs-tags-segment-push-message.md)功能鎖定這些人。
