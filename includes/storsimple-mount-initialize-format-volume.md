...
toowatch 的影片示範如何 toomount、 初始化、 和格式的 StorSimple 磁碟區中，按一下[這裡](https://azure.microsoft.com/documentation/videos/mount-initialize-and-format-a-storsimple-volume/)。
