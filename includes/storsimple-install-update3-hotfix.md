...
3. 在 hello hello Microsoft Update 類別目錄的搜尋方塊中輸入 hello 知識庫 (KB) 號碼 hello hotfix 您想讓 toodownload，例如**3186843**，然後按一下**搜尋**。
   
    hello hotfix 清單會出現，例如**StorSimple 8000 系列的累計軟體配套更新 3.0**。
   
    ![搜尋目錄](./media/storsimple-install-update2-hotfix/HCS_SearchCatalog1-include.png)
4. 按一下 [新增] 。 hello 更新已新增 toohello 籃。
5. Hello 上表中列出的搜尋任何其他的 hotfix (**3186859**)，並將每個 toohello 購物籃。
6. 按一下 [ **檢視購物籃**]。
...
1. Hello 軟體更新已完成之後，請確認 hello 系統軟體版本。 輸入：
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. 重複步驟 3-5 tooinstall hello LSI 驅動程式與韌體 hotfix **KB3186859**。 Hello hotfix 安裝之後，使用 hello `Get-HcsSystem` cmdlet。 hello LSI 版本應為：
   
   * `Lsisas2Version: 2.0.78.00`
3. 重複執行步驟 3-5 tooinstall hello Storport 太空更新**KB3121261**。
4. 如果您要更新的 Update 2 或更早版本，您也需要 toodownload:
