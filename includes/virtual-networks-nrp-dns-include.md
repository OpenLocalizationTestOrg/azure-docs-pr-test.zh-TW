...
| 屬性 | 說明 | 範例值 |
| --- | --- | --- |
| **DNSzones** |網域區域資訊 toohost DNS 記錄的特定網域 |/subscriptions/{guid}/.../providers/Microsoft.Network/dnszones/contoso.com" |
...
讀取 hello [DNS 區域的 REST API 文件](https://msdn.microsoft.com/library/azure/mt130626.aspx)如需詳細資訊。

讀取 hello [DNS 資料錄集的 REST API 文件](https://msdn.microsoft.com/library/azure/mt130627.aspx)如需詳細資訊。
